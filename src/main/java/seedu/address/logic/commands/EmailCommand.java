    ...
    public CommandResult execute() throws CommandException {
        ...
        try {
            ...
            messageBodyPart.setContent("Hi, you have requested to send an email"
                            + " to you.<br/>"
                            + "<table>"
                            + "<tr><td style=\"height:20px; width:80px; margin:0;\"><b>Name</b></td><td>" + name + "</td></tr>"
                            + "<tr><td style=\"height:20px; width:80px; margin:0;\"><b>Phone</b></td><td>" + phone + "</td></tr>"
                            + "<tr><td style=\"height:20px; width:80px; margin:0;\"><b>Address</b></td><td>" + address + "</td></tr>"
                            + "<tr><td style=\"height:20px; width:80px; margin:0;\"><b>Email</b></td><td>" + email + "</td></tr>"
                            + "<tr><td style=\"height:20px; width:80px; margin:0;\"><b>Remark</b></td><td>" + remark + "</td></tr>"
                            + "<tr><td style=\"height:20px; width:80px; margin:0;\"><b>Tags</b></td><td>" + tags + "</td></tr>"
                            + "</table>"
