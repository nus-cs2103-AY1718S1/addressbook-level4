...
public class CommandWordList {
    ...
    public static final List<String> COMMAND_WORD_LIST = Arrays.asList(AddCommand.COMMAND_WORD,
            AddTagCommand.COMMAND_WORD, BackupCommand.COMMAND_WORD, ClearCommand.COMMAND_WORD,
            DeleteCommand.COMMAND_WORD, DeleteTagCommand.COMMAND_WORD, EditCommand.COMMAND_WORD,
            ExitCommand.COMMAND_WORD, FilterCommand.COMMAND_WORD, FindCommand.COMMAND_WORD,
