...
public class AddCommandParser implements Parser<AddCommand> {
    ...
    public AddCommand parse(String args) throws ParseException {
        ...
        try {
            ...
            Email email = ParserUtil.parseEmail(argMultimap.getEmailOptionalValue(PREFIX_EMAIL)).get();
            Address address = ParserUtil.parseAddress(argMultimap.getAddressOptionalValue(PREFIX_ADDRESS)).get();
