...
public class AddCommandParser implements Parser<AddCommand> {
    ...
    public AddCommand parse(String args) throws ParseException {
        ...
        if (!arePrefixesPresent(argMultimap, PREFIX_NAME, PREFIX_PHONE, PREFIX_EMAIL, PREFIX_ADDRESS, PREFIX_FORMCLASS, PREFIX_GRADES, PREFIX_POSTALCODE)) {
        ...
        try {
            ...
            ReadOnlyPerson person = new Person(name, phone, email, address, formClass, grades, postalCode, tagList);
