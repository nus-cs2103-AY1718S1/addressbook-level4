...
public class AddCommandParser implements Parser<AddCommand> {
    ...
    public AddCommand parse(String args) throws ParseException {
        ...
        try {
            ...
            ReadOnlyPerson person = new Person(name, phone, email, address, birthday,
                    portraitPath, tagList, participationList);
     ...
     */
    public static Optional<Birthday> parseBirthdayForAdd(Optional<String> birthday) throws IllegalValueException {
