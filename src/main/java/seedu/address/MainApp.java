...
public class MainApp extends Application {
    ...
    private Model initModelManager(Storage storage, UserPrefs userPrefs) {
        ...
        ReadOnlyMeetingList initialMeetingListData;
        try {
            ...
            //storage.backupAddressBook(addressBookOptional.get());
            ...
            if (!meetingListOptional.isPresent()) {
                logger.info("Data file not found. Will be starting with a sample meeting list");
            }
            initialMeetingListData = meetingListOptional.orElseGet(SampleDataUtil::getSampleMeetingList);
    ...
    public void stop() {
        ...
        try {
            ...
            // To be replaced after meeting list is implemented to save after change event
            storage.saveMeetingList(model.getMeetingList());
        } catch (IOException e) {
