...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_COMMAND_FORMAT = "Oh no! The format you typed is not correct. Scroll down for " +
            "the correct format.\n%1$s";
    public static final String MESSAGE_INVALID_PERSON_DISPLAYED_INDEX = "Oh no! This index provided seems to be invalid.";
    public static final String MESSAGE_INVALID_TASK_DISPLAYED_INDEX = "Oh no! The task index provided seems to be invalid.";
