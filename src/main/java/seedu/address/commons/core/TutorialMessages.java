...
public class TutorialMessages {
    ...
    public static final String STEP_TWO = "This is the result display, where I will display the outcome of your commands.";
    public static final String STEP_THREE = "This is the sort menu, where you can select how to sort the list.";
    public static final String STEP_FOUR = "This is the search bar, where you are able to search for the person you want.";
    ...
    public static final String STEP_SIX = "Functions of BlueBird:\n"
            ...
            + "6. COMMAND\n"
            + "7. COMMAND\n";
    public static final String STEP_SEVEN = "Let's try deleting shall we?";
    public static final String STEP_EIGHT = "Delete confirmed!";
