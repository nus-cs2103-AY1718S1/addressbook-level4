 ...
 *
 */
public class ObservableTreeMapWrapper<K, V> implements ObservableMap<K, V> {
    ...
    public ObservableTreeMapWrapper(TreeMap<K, V> map) {
        this.backingMap = map;
    }
    ...
    private class SimpleChange extends MapChangeListener.Change<K,V> {
        ...
        public SimpleChange(K key, V old, V added, boolean wasAdded, boolean wasRemoved) {
            super(ObservableTreeMapWrapper.this);
    ...
    private class ObservableKeySet implements Set<K>{
        ...
        public boolean remove(Object o) {
            return ObservableTreeMapWrapper.this.remove(o) != null;
        }
        ...
        @Override
        public void clear() {
            ObservableTreeMapWrapper.this.clear();
        }
