    ...
    public static Person[] getSamplePersons() {
        try {
            return new Person[] {
                ...
                new Person(new Name("Ben Spore"), new Phone("23123532"), new Email("ben@example.com"),
                        new Address("Blk 2, Mango Street 85, #11-31"), new Appointment(""),
                        new ProfilePicture(DEFAULT_PICTURE),
                        getGroupSet("CS2108"), getTagSet()),
                new Person(new Name("Wo Cheng"), new Phone("92492021"), new Email("wo@example.com"),
                ...
                new Person(new Name("Patrick Smith"), new Phone("23123532"), new Email("patrick@example.com"),
                        ...
                        getGroupSet("CS2108"), getTagSet()),
                new Person(new Name("Ala Cybula"), new Phone("23512352"), new Email("ala@example.com"),
                        new Address("Mickiewicz Street 29, #06-40"), new Appointment("01/01/3000 00:00 60"),
                        new ProfilePicture(DEFAULT_PICTURE),
                        getGroupSet("University", "Family"), getTagSet("askForHackathon")),
                new Person(new Name("Janusz Brudnicki"), new Phone("95272758"), new Email("brudnicki@example.com"),
                        new Address("New Gardens, #07-18"), new Appointment(""),
                        new ProfilePicture(DEFAULT_PICTURE),
                        getGroupSet(), getTagSet()),
                new Person(new Name("Kamila Maslowska"), new Phone("34212342"), new Email("kamila@example.com"),
                        new Address("Bogata Street 65, #11-04"), new Appointment(""),
                        new ProfilePicture(DEFAULT_PICTURE),
                        getGroupSet("School"), getTagSet()),
                new Person(new Name("Patryk Karajas"), new Phone("91031282"), new Email("patrik@example.com"),
                        new Address("Daleka Street 2, #16-43"), new Appointment(""),
                        new ProfilePicture(DEFAULT_PICTURE),
                        getGroupSet(), getTagSet()),
                new Person(new Name("Mariusz Boganski"), new Phone("92492021"), new Email("mari@example.com"),
                        new Address("Blk 47 Tampines Street 20, #17-35"), new Appointment(""),
                        new ProfilePicture(DEFAULT_PICTURE),
                        getGroupSet(), getTagSet("hasMyPencil")),
                new Person(new Name("Adrian Males"), new Phone("92624417"), new Email("adramb@example.com"),
                        new Address("Blk 45 Aljunied Street 85, #11-31"), new Appointment(""),
                        new ProfilePicture(DEFAULT_PICTURE),
                        getGroupSet("CS2103"), getTagSet("owesMoney")),
                new Person(new Name("Agata Szalata"), new Phone("12343532"), new Email("agata@example.com"),
                        new Address("Blk 2, Mango Street 85, #11-31"), new Appointment(""),
                        new ProfilePicture("pic1.jpeg"),
                        getGroupSet("CS2108"), getTagSet()),
                new Person(new Name("Damian Franczk"), new Phone("92492021"), new Email("francik@example.com"),
                        new Address("Zachodnia Street 20, #11-01"), new Appointment(""),
                        new ProfilePicture("pic1.jpeg"),
                        getGroupSet(), getTagSet("hasMyPencil")),
                new Person(new Name("Peter Zuck"), new Phone("92214417"), new Email("peter@example.com"),
                        new Address("Blk 45 Strawberry Street 85, #11-31"), new Appointment(""),
                        new ProfilePicture(DEFAULT_PICTURE),
                        getGroupSet("CS2103"), getTagSet()),
                new Person(new Name("Stephen Muller"), new Phone("23123122"), new Email("stephen@example.com"),
