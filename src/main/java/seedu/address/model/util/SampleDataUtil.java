        ...
        try {
            return new Person[]{
                    new Person(new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                            ...
                            new Appointment("Alex Yeoh", getCalendar())),
                    ...
                    new Person(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                            ...
                            new Appointment("Bernice Yu", getCalendar())),

                    new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"),
                            new Email("charlotte@example.com"), new Address("Blk 11 Ang Mo Kio Street 74, #11-04"), new Bloodtype("AB"),
                            getTagSet("neighbours"), new Remark("Has her birthday next week"),
                            new Appointment("Charlotte Oliveiro", getCalendar())),
                    ...
                    new Person(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                            ...
                            new Appointment("David Li", getCalendar())),
                    ...
                    new Person(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                            ...
                            new Appointment("Irfan Ibrahim", getCalendar())),
                    ...
                    new Person(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
                            ...
                            new Appointment("Roy Balakrishnam", getCalendar()))
            };
