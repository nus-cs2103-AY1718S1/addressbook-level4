        ...
        try {
            return new Person[] {
                ...
                new Person(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                        ...
                        new Remark("As quick as a leopard."), new Website(Website.WEBSITE_NULL), getTagSet("family")),
                new Person(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                        new Address("Blk 47 Tampines Street 20, #17-35"), new Birthday("15/02/1992"),
                        new Remark(""), new Website(Website.WEBSITE_NULL), getTagSet("classmates")),
                new Person(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
                        new Address("Blk 45 Aljunied Street 85, #11-31"), new Birthday("15/02/1992"),
                        new Remark(""), new Website(Website.WEBSITE_NULL), getTagSet("colleagues"))
            };
