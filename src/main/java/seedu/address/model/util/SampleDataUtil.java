            ...
            return new Person[] {
                new Person(new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                    new Address("Blk 30 Geylang Street 29, #06-40"), new Remark(""),
                        new Website("https://github.com/AlexYeoh"), getTagSet("friends")),
                new Person(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                    new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"), new Remark("Likes to swim."),
                        new Website("https://github.com/BerniceYu"), getTagSet("colleagues", "friends")),
                ...
                new Person(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                    new Address("Blk 47 Tampines Street 20, #17-35"), new Remark(""),
                        new Website("https://github.com/IrfanIbrahim"), getTagSet("classmates")),
