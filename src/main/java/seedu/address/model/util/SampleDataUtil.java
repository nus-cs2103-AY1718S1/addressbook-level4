    ...
    public static Person[] getSamplePersons() {
        try {
            return new Person[] {
                ...
                new Person(new Name("Kommie Sarishi"), new Handphone("90797099"), new HomePhone("61999192"),
                    new OfficePhone(OfficePhone.NO_OFFICE_PHONE_SET), new Email("kls99@example.com"),
                ...
                new Person(new Name("Nigel Tan"), new Handphone("91102033"), new HomePhone("67773777"),
                    ...
                    new Deadline("31-12-2018"), getTagSet("unfriendly")),
