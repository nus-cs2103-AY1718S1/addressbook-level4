        ...
        try {
            return new Person[] {
                new Person(new Name("Alex Yeoh"), new Occupation("Google, Software Engineer"), new Phone("87438807"),
                        ...
                        new Remark(""), new Website("https://github.com/AlexYeoh"), getTagSet("friends")),
                new Person(new Name("Bernice Yu"), new Occupation("Apple, Janitor"), new Phone("99272758"),
                        new Email("berniceyu@example.com"), new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"),
                        new Remark("Likes to swim."), new Website("https://github.com/BerniceYu"),
                ...
                new Person(new Name("Charlotte Oliveiro"), new Occupation("Tan Tock Seng Hospital, Doctor"),
                        ...
                        new Website("https://github.com/CharlotteOliveiro"), getTagSet("neighbours")),
                new Person(new Name("David Li"), new Occupation("Prudential, Financial Assistant"),
                        ...
                        new Website("https://github.com/DavidLi"), getTagSet("family")),
                new Person(new Name("Irfan Ibrahim"), new Occupation("NUS, Professor"), new Phone("92492021"),
                        new Email("irfan@example.com"), new Address("Blk 47 Tampines Street 20, #17-35"),
                        new Remark(""), new Website("https://github.com/IrfanIbrahim"),
                        getTagSet("classmates")),
                new Person(new Name("Roy Balakrishnan"), new Occupation("Marlboro, CEO"), new Phone("92624417"),
                        new Email("royb@example.com"), new Address("Blk 45 Aljunied Street 85, #11-31"), new Remark(""),
                        new Website("https://github.com/RoyBalakrishnan"), getTagSet("colleagues"))
            };
