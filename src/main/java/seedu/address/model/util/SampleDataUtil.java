        ...
        try {
            return new Person[] {
                new Person(new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                    ...
                    new LastUpdated("2012-03-08T16:59:59.121Z"), getTagSet("friends"),
                        getMeetingSet("2017-11-25 10:00")),
                new Person(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                    new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"), new Note("Single"), new Id(""),
                    new LastUpdated("20163-07-08T14:30:00.121Z"), getTagSet("colleagues", "friends"),
                        getMeetingSet("2017-11-25 10:00")),
                ...
                new Person(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                    ...
                    new LastUpdated("2015-12-2T18:46:23.121Z"), getTagSet("family"),
