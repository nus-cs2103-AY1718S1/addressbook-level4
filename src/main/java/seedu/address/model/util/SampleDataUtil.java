    ...
    public static Person[] getSamplePersons() {
        try {
            return new Person[]{
                ...
                new Person(new Name("Bernice Yu"), new Phone("student/67375488 parent/97979797 "),
                ...
                new Person(new Name("Charlotte Oliveiro"), new Phone("student/62361502 parent/97979797 "),
                ...
                new Person(new Name("David Li"), new Phone("student/85473617 parent/97979797 "),
                ...
                new Person(new Name("Irfan Ibrahim"), new Phone("student/61243107 parent/97979797 "),
                ...
                new Person(new Name("Roy Balakrishnan"), new Phone("student/94534566 parent/97979797 "),
                ...
                new Person(new Name("Lynn Tan"), new Phone("student/84144141 parent/97979797 "),
                ...
                new Person(new Name("Mariam Mohamad"), new Phone("student/85215625 parent/97979797 "),
                ...
                new Person(new Name("Amy Leow"), new Phone("student/83245682 parent/97979797 "),
                ...
                new Person(new Name("Laura Teh"), new Phone("student/86542453 parent/97979797 "),
                ...
                new Person(new Name("Jolene Saram"), new Phone("student/85373543 parent/97979797 "),
                ...
                new Person(new Name("Laura Li"), new Phone("student/89345354 parent/97979797 "),
                ...
                new Person(new Name("Goh Qing Jing"), new Phone("student/85473617 parent/97979797 "),
                ...
                new Person(new Name("Thia Hon Teng"), new Phone("student/93455383 parent/97979797 "),
                        ...
                        new Remark("Studies suffering because of CCA"), getTagSet("studentCouncil", "needsHelp")),
                new Person(new Name("Dorothy Thia"), new Phone("student/93457384 parent/97979797 "),
                ...
                new Person(new Name("John Doe"), new Phone("student/95645686 parent/97979797 "),
                ...
                new Person(new Name("John Hoe"), new Phone("student/96575688 parent/97979797 "),
                ...
                new Person(new Name("John Shoe"), new Phone("student/96576756 parent/97979797 "),
                ...
                new Person(new Name("John Lowe"), new Phone("student/96575628 parent/97979797 "),
                ...
                new Person(new Name("Bruno Mas"), new Phone("student/96576578 parent/97979797 "),
                ...
                new Person(new Name("Nick Joe"), new Phone("student/65756867 parent/97979797 "),
                ...
                new Person(new Name("Chris Mar"), new Phone("student/96756857 parent/97979797 "),
                        ...
                        new Remark("I am a man"), getTagSet("band")),
                new Person(new Name("Fred Mer"), new Phone("student/96786566 parent/97979797 "),
                        ...
                        new Remark("I am a man"), getTagSet("band")),
                new Person(new Name("Camila C"), new Phone("student/67567288 parent/97979797 "),
                        new Email("alexyeoh@example.com"), new Address("Blk 30 Geylang Street 29, #06-40"),
                        new FormClass("16MUS20"), new Grades("750.0"), new PostalCode("123456"),
                        new Remark("I am a man"), getTagSet("band", "dance")),
                new Person(new Name("Rick Sanchez"), new Phone("student/97272031 parent/97979797 "),
                ...
                new Person(new Name("Morty Smith"), new Phone("student/96576578 parent/97979797 "),
                ...
                new Person(new Name("Summer Smith"), new Phone("student/65784657 parent/97979797 "),
                ...
                new Person(new Name("Beth Smith"), new Phone("student/68957567 parent/97979797 "),
                ...
                new Person(new Name("Jerry Smith"), new Phone("student/96742875 parent/97979797 "),
                ...
                new Person(new Name("Greg C"), new Phone("student/97272031 parent/97979797 "),
                ...
                new Person(new Name("Sandor C"), new Phone("student/97564654 parent/97979797 "),
                ...
                new Person(new Name("Cersi Lan"), new Phone("student/67282459 parent/97979797 "),
                        new Email("alexyeoh@example.com"), new Address("Kings Street 1, #01-40"),
                ...
                new Person(new Name("James Lan"), new Phone("student/67278538 parent/97979797 "),
                        new Email("alexyeoh@example.com"), new Address("Kings Street 1, #01-40"),
                ...
                new Person(new Name("Tywin Lan"), new Phone("student/86545248 parent/97979797 "),
