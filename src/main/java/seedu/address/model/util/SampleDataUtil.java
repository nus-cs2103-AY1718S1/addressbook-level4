    ...
    public static Person[] getSamplePersons() {
        try {
            return new Person[] {
                ...
                new Person(new Name("Erfan Ibrahim"), new Phone("92492021"), new Email("eirfan@example.com"),
                ...
                new Person(new Name("Koung Ashley"), new Phone("82233417"), new Email("kashleyy@example.com"),
                        ...
                        new FavouriteStatus(false), getTagSet("classmates"), new Link("")),
                new Person(new Name("Lacob Yasim"), new Phone("82664417"), new Email("LacobYas@example.com"),
                ...
                new Person(new Name("Zachary Tan"), new Phone("82623417"), new Email("jacobYas@example.com"),
                        ...
                        new FavouriteStatus(false), getTagSet("classmates"), new Link("")),
                new Person(new Name("Zack Jojo"), new Phone("82623417"), new Email("zackjojo@example.com"),
