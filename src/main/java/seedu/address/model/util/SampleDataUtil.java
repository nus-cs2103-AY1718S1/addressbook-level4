        ...
        try {
            return new Person[] {
                ...
                new Person(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                    ...
                    new Debt("100"), new Deadline(Deadline.NO_DEADLINE_SET), getTagSet("colleagues", "friends")),
                new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
                    new Address("Blk 11 Ang Mo Kio Street 74, #11-04"), new PostalCode("560011"),
                    new Debt("300"), new Deadline(Deadline.NO_DEADLINE_SET), getTagSet("neighbours")),
                new Person(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                    new Address("Blk 436 Serangoon Gardens Street 26, #16-43"), new PostalCode("554436"),
                    new Debt("50"), new Deadline(Deadline.NO_DEADLINE_SET), getTagSet("family")),
                ...
                new Person(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
                    ...
                    new Debt("15630"), new Deadline(Deadline.NO_DEADLINE_SET), getTagSet("colleagues"))
            };
