...
public class AddressContainsKeywordsPredicateTest {
    ...
    public void test_addressContainsKeywords_returnsTrue() {
        ...
        assertTrue(predicate.test(new PersonBuilder().withAddress("123, Jurong West Ave 6, #08-111, Singapore 409999").build()));
    ...
    public void test_addressDoesNotContainKeywords_returnsFalse() {
        ...
        assertFalse(predicate.test(new PersonBuilder().withAddress("123, Jurong West Ave 6, #08-111, Singapore 409999").build()));
        ...
        assertFalse(predicate.test(new PersonBuilder().withName("Alice").withPhone("12345")
                .withEmail("alice@email.com").withAddress("123, Jurong West Ave 6, #08-111, Singapore 40999").build()));
    }
}
