...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + LECTURER_DESC_MA1101R + LECTURER_DESC_CS2101 + TAG_EMPTY, Lecturer.MESSAGE_LECTURER_CONSTRAINTS);
        assertParseFailure(parser, "1" + LECTURER_DESC_MA1101R + TAG_EMPTY + LECTURER_DESC_CS2101, Lecturer.MESSAGE_LECTURER_CONSTRAINTS);
        assertParseFailure(parser, "1" + TAG_EMPTY + LECTURER_DESC_MA1101R + LECTURER_DESC_CS2101, Lecturer.MESSAGE_LECTURER_CONSTRAINTS);
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        EditLessonDescriptor descriptor = new EditLessonDescriptorBuilder().withClassType(VALID_CLASSTYPE_CS2101).build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
