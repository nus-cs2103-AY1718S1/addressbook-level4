...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_HOME_NUM_DESC, HomeNumber.MESSAGE_HOME_NUMBER_CONSTRAINTS);
        //invalid homenumber
        assertParseFailure(parser, "1" + INVALID_EMAIL_DESC, Email.MESSAGE_EMAIL_CONSTRAINTS); // invalid email
        assertParseFailure(parser, "1" + INVALID_SCH_EMAIL_DESC, SchEmail.MESSAGE_SCH_EMAIL_CONSTRAINTS);
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + TAG_DESC_HUSBAND
                ...
                + WEBSITE_DESC_AMY + HOME_NUM_DESC_AMY
                + ADDRESS_DESC_AMY + BIRTHDAY_DESC_AMY
                + NAME_DESC_AMY + TAG_DESC_FRIEND;

        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_BOB)
                .withHomeNumber(VALID_HOME_NUM_AMY)
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        // school email
        userInput = targetIndex.getOneBased() + SCH_EMAIL_DESC_AMY;
        descriptor = new EditPersonDescriptorBuilder().withSchEmail(VALID_SCH_EMAIL_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        ...
        String userInput = targetIndex.getOneBased()  + PHONE_DESC_AMY + ADDRESS_DESC_AMY + EMAIL_DESC_AMY
                + SCH_EMAIL_DESC_AMY + WEBSITE_DESC_BOB + HOME_NUM_DESC_AMY
                + TAG_DESC_FRIEND + PHONE_DESC_AMY + ADDRESS_DESC_AMY + EMAIL_DESC_AMY
                + SCH_EMAIL_DESC_BOB + TAG_DESC_FRIEND
                + WEBSITE_DESC_BOB + HOME_NUM_DESC_BOB
                + PHONE_DESC_BOB + ADDRESS_DESC_BOB + BIRTHDAY_DESC_AMY
