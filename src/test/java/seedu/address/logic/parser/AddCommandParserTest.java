...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Parcel expectedParcel = new ParcelBuilder().withTrackingNumber(VALID_TRACKING_NUMBER_BOB).withName(VALID_NAME_BOB)
    ...
    public void parse_optionalFieldsMissing_success() {
        // zero tags
        Parcel expectedParcel = new ParcelBuilder().withTrackingNumber(VALID_TRACKING_NUMBER_AMY).withName(VALID_NAME_AMY)
