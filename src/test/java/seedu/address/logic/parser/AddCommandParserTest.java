...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, AddCommand.COMMAND_WORD + NAME_DESC_AMY + NAME_DESC_BOB + PHONE_DESC_BOB
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_FRIEND + FACEBOOK_DESC_BOB
                + TWIITER_DESC_BOB + INSTAGRAM_DESC_BOB, new AddCommand(expectedPerson));
        ...
        assertParseSuccess(parser, AddCommand.COMMAND_WORD + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_AMY + ADDRESS_DESC_BOB + TAG_DESC_FRIEND + FACEBOOK_DESC_BOB
                + TWIITER_DESC_BOB + INSTAGRAM_DESC_BOB, new AddCommand(expectedPerson));
        ...
        assertParseSuccess(parser, AddCommand.COMMAND_WORD + NAME_DESC_BOB + PHONE_DESC_BOB
                        + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND + FACEBOOK_DESC_BOB
                        + TWIITER_DESC_BOB + INSTAGRAM_DESC_BOB,
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + FACEBOOK_DESC_AMY
                + TWIITER_DESC_AMY + INSTAGRAM_DESC_AMY, new AddCommand(expectedPerson));
    }
