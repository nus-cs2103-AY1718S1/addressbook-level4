...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Parcel expectedParcel = new ParcelBuilder().withArticleNumber(VALID_ARTICLE_NUMBER_BOB).withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB)
                .withTags(VALID_TAG_FRIEND).build();

        // multiple names - last name accepted
        assertParseSuccess(parser, AddCommand.COMMAND_WORD + ARTICLE_NUMBER_DESC_BOB + NAME_DESC_AMY
                + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_FRIEND,
                new AddCommand(expectedParcel));

        // multiple phones - last phone accepted
        assertParseSuccess(parser, AddCommand.COMMAND_WORD + ARTICLE_NUMBER_DESC_BOB + NAME_DESC_BOB +
        ...
        Parcel expectedParcelMultipleTags = new ParcelBuilder().withArticleNumber(VALID_ARTICLE_NUMBER_BOB)
    ...
    public void parse_optionalFieldsMissing_success() {
        // zero tags
        Parcel expectedParcel = new ParcelBuilder().withArticleNumber(VALID_ARTICLE_NUMBER_AMY).withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY).withTags()
                .build();
        assertParseSuccess(parser, AddCommand.COMMAND_WORD + ARTICLE_NUMBER_DESC_AMY + NAME_DESC_AMY +
                PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY, new AddCommand(expectedParcel));
    }
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing article number prefix
        assertParseFailure(parser, AddCommand.COMMAND_WORD + VALID_ARTICLE_NUMBER_BOB + NAME_DESC_BOB +
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, AddCommand.COMMAND_WORD + INVALID_ARTICLE_NUMBER_DESC + INVALID_NAME_DESC
                + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                ArticleNumber.MESSAGE_ARTICLE_NUMBER_CONSTRAINTS);

        // invalid name
        assertParseFailure(parser, AddCommand.COMMAND_WORD + ARTICLE_NUMBER_DESC_BOB + INVALID_NAME_DESC +
                PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                Name.MESSAGE_NAME_CONSTRAINTS);

        // invalid phone
        assertParseFailure(parser, AddCommand.COMMAND_WORD + ARTICLE_NUMBER_DESC_BOB + NAME_DESC_BOB +
        ...
        assertParseFailure(parser, AddCommand.COMMAND_WORD + ARTICLE_NUMBER_DESC_BOB + INVALID_NAME_DESC +
                PHONE_DESC_BOB + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC, Name.MESSAGE_NAME_CONSTRAINTS);
    }
}
