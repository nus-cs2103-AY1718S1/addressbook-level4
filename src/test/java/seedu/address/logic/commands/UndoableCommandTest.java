...
public class UndoableCommandTest {
    private final Model model = new ModelManager(getTypicalRolodex(), new UserPrefs());
    private final DummyCommand dummyCommand = new DummyCommand(model);

    private Model expectedModel = new ModelManager(getTypicalRolodex(), new UserPrefs());
    ...
    public void executeUndo() throws Exception {
        ...
        dummyCommand.undo();
        expectedModel = new ModelManager(getTypicalRolodex(), new UserPrefs());
        assertEquals(expectedModel, model);
    }
