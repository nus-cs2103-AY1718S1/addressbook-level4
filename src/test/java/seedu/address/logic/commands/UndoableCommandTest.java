...
public class UndoableCommandTest {
    private final Model model = new ModelManager(getTypicalAddressBook(), getTypicalDatabase(), new UserPrefs());
    private final DummyCommand dummyCommand = new DummyCommand(model);

    private Model expectedModel = new ModelManager(getTypicalAddressBook(), getTypicalDatabase(), new UserPrefs());
    ...
    public void executeUndo() throws Exception {
        ...
        dummyCommand.undo();
        expectedModel = new ModelManager(getTypicalAddressBook(), getTypicalDatabase(), new UserPrefs());
        assertEquals(expectedModel, model);
    }
