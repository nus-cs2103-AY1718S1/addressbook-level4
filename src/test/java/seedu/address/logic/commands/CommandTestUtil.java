...
public class CommandTestUtil {
    ...
    public static final String EMPTY_BIRTHDAY = null;
    ...
    public static final String INVALID_BIRTHDAY_DESC = " "
                                + PREFIX_BIRTHDAY + "265/01/19999"; // dates should be in dd/MM/yyyy format
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withBirthday(VALID_BIRTHDAY_AMY).withWebsite(VALID_WEBSITE_AMY)
