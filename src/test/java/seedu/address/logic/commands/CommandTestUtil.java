...
public class CommandTestUtil {
    ...
    public static final String INVALID_BIRTHDAY_DESC= " " + PREFIX_BIRTHDAY + "265/01/19999"; // dates should be in dd/MM/yyyy format
    public static final String INVALID_WEBSITE_DESC = " " + PREFIX_WEBSITE + "www.yahoo.com";
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY).withBirthday(VALID_BIRTHDAY_AMY).withWebsite(VALID_WEBSITE_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB).withBirthday(VALID_BIRTHDAY_BOB).withWebsite(VALID_WEBSITE_BOB)
