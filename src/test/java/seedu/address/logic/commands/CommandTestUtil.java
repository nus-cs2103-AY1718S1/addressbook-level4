...
public class CommandTestUtil {
    ...
    public static final String VALID_FAVORITE_YES = "yes";
    public static final String VALID_FAVORITE_NO = "no";
    ...
    public static final String FAVORITE_DESC_YES = " " + PREFIX_FAVORITE + VALID_FAVORITE_YES;
    public static final String FAVORITE_DESC_NO = " " + PREFIX_FAVORITE + VALID_FAVORITE_NO;
    ...
    public static final String INVALID_FAVORITE_DESC = " " + PREFIX_FAVORITE; // empty string not allowed for favorite
