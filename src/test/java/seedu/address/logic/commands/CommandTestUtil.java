...
public class CommandTestUtil {
    ...
    public static final String VALID_ARTICLE_NUMBER_AMY = "RR231476598SG";
    public static final String VALID_ARTICLE_NUMBER_BOB = "RR123456897SG";
    ...
    public static final String ARTICLE_NUMBER_DESC_AMY = " " + PREFIX_ARTICLE_NUMBER + VALID_ARTICLE_NUMBER_AMY;
    public static final String ARTICLE_NUMBER_DESC_BOB = " " + PREFIX_ARTICLE_NUMBER + VALID_ARTICLE_NUMBER_BOB;
    ...
    public static final String INVALID_ARTICLE_NUMBER_DESC = " " + PREFIX_ARTICLE_NUMBER
    ...
    static {
        DESC_AMY = new EditParcelDescriptorBuilder().withName(VALID_NAME_AMY)
