...
public class CommandTestUtil {
    ...
    public static final String VALID_BIRTHDAY_BOB = "12/10/1992";
    ...
    public static final String INVALID_BIRTHDAY_DESC = " " + PREFIX_BIRTHDAY + "2/01/1994"; // two digits are required
