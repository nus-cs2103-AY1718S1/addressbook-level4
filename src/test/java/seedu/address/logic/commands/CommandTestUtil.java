...
public class CommandTestUtil {
    ...
    public static final String STATUS_DESC_AMY = " " + PREFIX_STATUS + VALID_DELIVERYDATE_AMY;
    public static final String STATUS_DESC_BOB = " " + PREFIX_STATUS + VALID_DELIVERYDATE_BOB;
