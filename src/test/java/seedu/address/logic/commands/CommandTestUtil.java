...
public class CommandTestUtil {
    ...
    public static final String VALID_APPOINTMENT = "01/01/20 00:00 60";
    ...
    public static final String GROUP_NAME_DESC_FAMILY = " " + PREFIX_GROUP_NAME + VALID_GROUP_NAME_CS2103;
    public static final String GROUP_NAME_DESC_CS2103 = " " + PREFIX_GROUP_NAME + VALID_GROUP_NAME_CS2103;
    public static final String APPOINTMENT_DESC = " " + PREFIX_APPOINT + VALID_APPOINTMENT;
    ...
    public static final String INVALID_GROUP_NAME_DESC = " " + PREFIX_GROUP_NAME + "Work*"; // '*' not allowed in tags
