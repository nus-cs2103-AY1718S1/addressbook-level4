...
public class UploadPhotoCommandTest {
    ...
    public void execute_validIndex_success() throws Exception {
        ...
        UploadPhotoCommand uploadPhotoCommand = prepareCommand(INDEX_FIRST_PERSON, ".\\src\\test\\resources\\photos\\connectus_icon.png");
    ...
    @Test
    public void execute_invalidIndex_validFile_throwsCommandException() throws Exception {
        Index outOfBoundIndex = Index.fromOneBased(model.getFilteredPersonList().size() + 1);
        UploadPhotoCommand uploadPhotoCommand = prepareCommand(outOfBoundIndex,".\\src\\test\\resources\\photos\\connectus_icon.png");

        assertCommandFailure(uploadPhotoCommand, model, Messages.MESSAGE_INVALID_PERSON_DISPLAYED_INDEX);
    }

    @Test
    public void execute_validIndex_invalidFile_throwsCommandException() throws Exception {
        ReadOnlyPerson personToUploadPhoto = model.getFilteredPersonList().get(INDEX_FIRST_PERSON.getZeroBased());
        UploadPhotoCommand uploadPhotoCommand = prepareCommand(INDEX_FIRST_PERSON, ".\\src\\test\\resources\\photos\\default.jpeg");
