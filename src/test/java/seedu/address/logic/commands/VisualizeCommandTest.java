...
public class VisualizeCommandTest {
    ...
    private void assertExecutionSuccess(Index index) {
        VisualizeCommand visualizeCommand = prepareCommand(index);

        try {
            CommandResult commandResult = visualizeCommand.execute();
            assertEquals(String.format(VisualizeCommand.MESSAGE_VISUALIZE_PERSON_SUCCESS, index.getOneBased()),
