...
public class ExpireCommandTest {
    ...
    @Test
    public void equals() {
        final ExpireCommand standardCommand = new ExpireCommand(INDEX_FIRST_PERSON, VALID_EXPIRE_AMY);

        // same value -> returns true
        ExpireCommand commandWithSameValues = new ExpireCommand(INDEX_FIRST_PERSON, VALID_EXPIRE_AMY);
        ...
        assertFalse(standardCommand.equals(new ExpireCommand(INDEX_SECOND_PERSON, VALID_EXPIRE_AMY)));
     ...
     */
    private ExpireCommand prepareCommand(Index index, String dateString) {
        ExpireCommand expireCommand = new ExpireCommand(index, dateString);
