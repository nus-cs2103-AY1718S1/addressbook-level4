...
public class IndexTest {
    ...
    @Test
    public void equals() {
        final Index fifthParcelIndex = Index.fromOneBased(5);

        // same values -> returns true
        assertTrue(fifthParcelIndex.equals(Index.fromOneBased(5)));
        assertTrue(fifthParcelIndex.equals(Index.fromZeroBased(4)));

        // same object -> returns true
        assertTrue(fifthParcelIndex.equals(fifthParcelIndex));

        // null -> returns false
        assertFalse(fifthParcelIndex.equals(null));

        // different types -> returns false
        assertFalse(fifthParcelIndex.equals(5.0f));

        // different index -> returns false
        assertFalse(fifthParcelIndex.equals(Index.fromOneBased(1)));
    }
}
