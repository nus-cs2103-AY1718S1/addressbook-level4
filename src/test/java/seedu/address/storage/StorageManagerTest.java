...
public class StorageManagerTest {
    ...
    public void setUp() {
        ...
        XmlRecycleBinStorage recycleBinStorage = new XmlRecycleBinStorage(getTempFilePath("rb"));
        JsonUserPrefsStorage userPrefsStorage = new JsonUserPrefsStorage(getTempFilePath("prefs"));
        storageManager = new StorageManager(addressBookStorage, recycleBinStorage, userPrefsStorage);
    }
