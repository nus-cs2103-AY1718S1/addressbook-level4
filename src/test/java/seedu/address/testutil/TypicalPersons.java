...
public class TypicalPersons {
    ...
    public static final ReadOnlyPerson ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withPhone("85355255").withWebsite("https://github.com/AlicePauline")
    ...
    public static final ReadOnlyPerson DANIEL = new PersonBuilder().withName("Daniel Meier")
            ...
            .withAddress("10th street").withWebsite("https://github.com/DanielMeier")
    ...
    public static final ReadOnlyPerson GEORGE = new PersonBuilder().withName("George Best").withPhone("9482442")
            ...
            .withAddress("4th street").withWebsite("https://github.com/GeorgeBest")
            .build();

    // Manually added
    public static final ReadOnlyPerson HOON = new PersonBuilder().withName("Hoon Meier").withPhone("8482424")
            .withEmail("stefan@example.com").withAddress("little india").withWebsite("https://github.com/HoonMeier").build();
    public static final ReadOnlyPerson IDA = new PersonBuilder().withName("Ida Mueller").withPhone("8482131")
            .withEmail("hans@example.com").withAddress("chicago ave").withWebsite("https://github.com/IdaMueller").build();

    // Manually added - Person's details found in {@code CommandTestUtil}
    public static final ReadOnlyPerson AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            .withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY).withWebsite(VALID_WEBSITE_AMY).withTags(VALID_TAG_FRIEND).build();
    public static final ReadOnlyPerson BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            .withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB).withWebsite(VALID_WEBSITE_BOB).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND)
            .build();
