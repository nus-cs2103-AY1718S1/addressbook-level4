...
public class TypicalPersons {
    ...
    public static final ReadOnlyPerson ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withPhone("85355255").withFavourite("True")
            .withTags("friends").build();
    public static final ReadOnlyPerson BENSON = new PersonBuilder().withName("Benson Meier")
            .withAddress("311, Clementi Ave 2, #02-25")
            .withEmail("johnd@example.com").withPhone("98765432").withFavourite("True")
    ...
    public static final ReadOnlyPerson FIONA = new PersonBuilder().withName("Fiona Kunz").withPhone("9482427")
            ...
            .withTags("colleague", "friend").build();
    ...
    public static final String KEYWORD_MATCHING_FRIEND = "friend"; // A keyword that matches friend
