...
public class TypicalPersons {
    ...
    public static final ReadOnlyPerson ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withTags("friends").withAppointment("Lunch, tomorrow 5pm to 10pm").build();
    public static final ReadOnlyPerson BENSON = new PersonBuilder().withName("Benson Meier")
            .withAddress("311, Clementi Ave 2, #02-25").withBloodType("A-")
            .withEmail("johnd@example.com").withPhone("98765432")
            .withTags("owesMoney", "friends").withAppointment("Meeting, tomorrow 3pm").build();
    public static final ReadOnlyPerson CARL = new PersonBuilder().withName("Carl Kurz").withPhone("95352563")
            .withEmail("heinz@example.com").withAddress("wall street")
            .withBloodType("AB").withTags("Test1").build();
    ...
    public static final ReadOnlyPerson AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            ...
            .withBloodType(VALID_BLOODTYPE_AMY).withTags(VALID_TAG_FRIEND).withAppointment(VALID_APPOINTMENT_AMY)
            .build();
    public static final ReadOnlyPerson BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            .withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB).withBloodType(VALID_BLOODTYPE_BOB)
            .withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).withAppointment(VALID_APPOINTMENT_BOB).build();
