...
public class TypicalPersons {
    ...
    public static final ReadOnlyPerson ALICE = new PersonBuilder().withName("Alice Pauline")
            .withPhone("97979797").withParentPhone("96753511").withAddress("123, Jurong West Ave 6, #08-111")
            .withEmail("alice@example.com").withFormClass("12S23").withGrades("125.0").withPostalCode("279392")
            .withTags("friends")
            .build();
    public static final ReadOnlyPerson BENSON = new PersonBuilder().withName("Benson Meier")
            .withPhone("97979797").withParentPhone("96753511").withAddress("311, Clementi Ave 2, #02-25")
    ...
    public static final ReadOnlyPerson CARL = new PersonBuilder().withName("Carl Kurz")
            .withPhone("97979797").withParentPhone("96753511").withEmail("heinz@example.com").withAddress("wall street")
    ...
    public static final ReadOnlyPerson GEORGE = new PersonBuilder().withName("George Best")
            .withPhone("97979797").withParentPhone("96753511").withEmail("anna@example.com").withAddress("4th street")
    ...
    public static final ReadOnlyPerson IDA = new PersonBuilder().withName("Ida Mueller")
            .withPhone("97979797").withParentPhone("96753511").withEmail("hans@example.com").withAddress("chicago ave")
