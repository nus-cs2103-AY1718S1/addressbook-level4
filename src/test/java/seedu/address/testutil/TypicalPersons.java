...
public class TypicalPersons {
    ...
    public static final ReadOnlyPerson DANIEL = new PersonBuilder().withName("Daniel Meier").withPhone("87652533")
            ...
            .withBloodType("B-").withAppointment("Daniel Meier").build();
    public static final ReadOnlyPerson ELLE = new PersonBuilder().withName("Elle Meyer").withPhone("9482224")
            .withEmail("werner@example.com").withAddress("michegan ave")
            .withBloodType("A").withTags("Test2").withAppointment("Elle Meyer").build();
    ...
    public static final ReadOnlyPerson JON = new PersonBuilder().withName("George Best").withPhone("9482442")
    ...
    public static final ReadOnlyPerson IDA = new PersonBuilder().withName("Ida Mueller").withPhone("8482131")
            ...
            .withBloodType("O").withAppointment("Ida Mueller").build();

    // Manually added - Person's details found in {@code CommandTestUtil}
    public static final ReadOnlyPerson AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            .withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
            .withBloodType(VALID_BLOODTYPE_AMY).withTags(VALID_TAG_FRIEND).withAppointment(VALID_NAME_AMY).build();
    public static final ReadOnlyPerson BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            .withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB).withBloodType(VALID_BLOODTYPE_BOB)
            .withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).withAppointment(VALID_NAME_BOB).build();
