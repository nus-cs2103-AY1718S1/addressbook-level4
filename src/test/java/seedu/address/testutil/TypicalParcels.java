...
public class TypicalParcels {
    ...
    public static final ReadOnlyParcel ALICE = new ParcelBuilder().withArticleNumber("RR000111000SG")
    ...
    public static final ReadOnlyParcel BENSON = new ParcelBuilder().withArticleNumber("RR111000111SG")
    ...
    public static final ReadOnlyParcel CARL = new ParcelBuilder().withArticleNumber("RR222000111SG")
            .withName("Carl Kurz").withPhone("95352563").withEmail("heinz@example.com")
            .withAddress("18 Marina Blvd, S018980").build();
    public static final ReadOnlyParcel DANIEL = new ParcelBuilder().withArticleNumber("RR111321123SG")
            .withName("Daniel Meier").withPhone("87652533").withEmail("cornelia@example.com")
            .withAddress("59 Namly Garden S267387").build();
    public static final ReadOnlyParcel ELLE = new ParcelBuilder().withArticleNumber("RR111321124SG")
            .withName("Elle Meyer").withPhone("9482224").withEmail("werner@example.com")
            .withAddress("2 Finlayson Green, S049247").build();
    public static final ReadOnlyParcel FIONA = new ParcelBuilder().withArticleNumber("RR999123555SG")
            .withName("Fiona Kunz").withPhone("9482427").withEmail("lydia@example.com")
            .withAddress("48 Upper Dickson Rd S207502").build();
    public static final ReadOnlyParcel GEORGE = new ParcelBuilder().withArticleNumber("RR696969696SG")
    ...
    // Manually added
    public static final ReadOnlyParcel HOON = new ParcelBuilder().withArticleNumber("RR121212124SG")
            .withName("Hoon Meier").withPhone("8482424").withEmail("stefan@example.com")
            .withAddress("522 Hougang Ave 6 s530522").build();
    public static final ReadOnlyParcel IDA = new ParcelBuilder().withArticleNumber("RR111333888SG")
            .withName("Ida Mueller").withPhone("8482131").withEmail("hans@example.com")
            .withAddress("3 River Valley Rd, S179024").build();

    // Manually added - Parcel's details found in {@code CommandTestUtil}
    public static final ReadOnlyParcel AMY = new ParcelBuilder().withArticleNumber(VALID_ARTICLE_NUMBER_AMY)
            .withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY)
            .withAddress(VALID_ADDRESS_AMY).withTags(VALID_TAG_FRIEND).build();
    public static final ReadOnlyParcel BOB = new ParcelBuilder().withArticleNumber(VALID_ARTICLE_NUMBER_BOB)
