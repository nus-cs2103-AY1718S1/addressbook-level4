...
public class PersonBuilder {
    ...
    public static final String DEFAULT_BIRTHDAY = "14/10/1992";
    public static final String DEFAULT_PATH = "sample.jpg";
    ...
    public PersonBuilder() {
        try {
            ...
            PortraitPath defaultPath = new PortraitPath(DEFAULT_PATH);
            Set<Tag> defaultTags = SampleDataUtil.getTagSet(DEFAULT_TAGS);
            Set<Event> defaultParticipation = new HashSet<>();
            this.person = new Person(defaultName, defaultPhone, defaultEmail, defaultAddress, defaultBirthday,
                    defaultPath, defaultTags, defaultParticipation);
