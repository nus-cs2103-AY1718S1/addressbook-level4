...
public class StatusBarFooterHandle extends NodeHandle<Node> {
    ...
    public StatusBarFooterHandle(Node statusBarFooterNode) {
        ...
        this.totalPersonNode = getChildNode(TOTAL_PERSONS_ID);
    }
    ...
    public String getTotalPerson() {
        return totalPersonNode.getText();
    }
     ...
     */
    public void rememberTotalPerson() {
        lastRememberedTotalPerson = getTotalPerson();
    }

    /**
     * Returns true if the current content of the total persons is different from the value remembered by the most
     * recent {@code rememberTotalPerson()} call.
     */
    public boolean isTotalPersonChanged() {
        return !lastRememberedTotalPerson.equals(getTotalPerson());
    }
}
