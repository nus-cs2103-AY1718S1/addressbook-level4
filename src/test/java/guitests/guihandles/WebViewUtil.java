...
public class WebViewUtil {
    ...
    /**
     * If the {@code profilePanelHandle}'s {@code WebView} is loading, sleeps the thread till it is successfully loaded.
     */
    public static void waitUntilBrowserLoaded(ProfilePanelHandle profilePanelHandle) {
        new GuiRobot().waitForEvent(profilePanelHandle::isLoaded);
    }
}
