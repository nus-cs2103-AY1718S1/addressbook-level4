...
public class AddCommandSystemTest extends AddressBookSystemTest {
    ...
    public void add() throws Exception {
        ...
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + PARENTPHONE_DESC_AMY
        ...
        toAdd = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_AMY)
                ...
                .build();
        command = AddCommand.COMMAND_WORD + NAME_DESC_BOB + PHONE_DESC_AMY + PARENTPHONE_DESC_AMY
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                + FORMCLASS_DESC_AMY + GRADES_DESC_AMY + POSTALCODE_DESC_AMY + TAG_DESC_FRIEND;
        assertCommandSuccess(command, toAdd);
        ...
        toAdd = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_BOB)
                ...
                .withPostalCode(VALID_POSTALCODE_AMY).withTags(VALID_TAG_FRIEND)
                .build();
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_BOB + PARENTPHONE_DESC_AMY
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                + FORMCLASS_DESC_AMY + GRADES_DESC_AMY + POSTALCODE_DESC_AMY + TAG_DESC_FRIEND;
        assertCommandSuccess(command, toAdd);
        ...
        toAdd = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
                .withParentPhone(VALID_PARENTPHONE_AMY).withEmail(VALID_EMAIL_BOB)
                .withAddress(VALID_ADDRESS_AMY).withFormClass(VALID_FORMCLASS_AMY).withGrades(VALID_GRADES_AMY)
                .withPostalCode(VALID_POSTALCODE_AMY).withTags(VALID_TAG_FRIEND)
                .build();
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + PARENTPHONE_DESC_AMY
        ...
        toAdd = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
                ...
                .build();
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY
                + PARENTPHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_BOB
                + FORMCLASS_DESC_AMY + GRADES_DESC_AMY + POSTALCODE_DESC_AMY + TAG_DESC_FRIEND;
        assertCommandSuccess(command, toAdd);
        ...
        toAdd = BOB;
        command = AddCommand.COMMAND_WORD + TAG_DESC_FRIEND + PHONE_DESC_BOB + PARENTPHONE_DESC_BOB
        ...
        command = AddCommand.COMMAND_WORD + INVALID_NAME_DESC + PHONE_DESC_AMY + PARENTPHONE_DESC_AMY
                + EMAIL_DESC_AMY + FORMCLASS_DESC_AMY
                + GRADES_DESC_AMY + ADDRESS_DESC_AMY + POSTALCODE_DESC_AMY;
        assertCommandFailure(command, Name.MESSAGE_NAME_CONSTRAINTS);

        /* Case: invalid phone -> rejected */
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + INVALID_PHONE_DESC + PARENTPHONE_DESC_AMY
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
        ...
        /* Case: invalid parent phone number -> rejected */
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + INVALID_PARENTPHONE_DESC
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                + GRADES_DESC_AMY + FORMCLASS_DESC_AMY + POSTALCODE_DESC_AMY + TAG_DESC_FRIEND;
        assertCommandFailure(command, ParentPhone.MESSAGE_PARENTPHONE_CONSTRAINTS);
    }
