...
import static seedu.address.logic.commands.CommandTestUtil.TIMESTAMP_DESC_AMY;
import static seedu.address.logic.commands.CommandTestUtil.TIMESTAMP_DESC_BOB;
...
public class AddCommandSystemTest extends AddressBookSystemTest {
    ...
    public void add() throws Exception {
        ...
        toAdd = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY)
                .withAddress(VALID_ADDRESS_AMY).withTemporary(0).withTags(VALID_TAG_FRIEND).build();
        ...
        toAdd = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY)
                .withAddress(VALID_ADDRESS_BOB).withTemporary(0).withTags(VALID_TAG_FRIEND).build();
