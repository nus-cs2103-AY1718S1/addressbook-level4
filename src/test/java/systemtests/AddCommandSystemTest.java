...
public class AddCommandSystemTest extends AddressBookSystemTest {
    ...
    public void add() throws Exception {
        ...
        except name and email -> added */
        toAdd = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_AMY)
                .withEmail("amy1@example.com").withAddress(VALID_ADDRESS_AMY).withTags(VALID_TAG_FRIEND).build();
        ...
        /* Case: add a person with all fields same as another person in the address book
        except address and email -> added */
