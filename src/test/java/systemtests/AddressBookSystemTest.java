...
public abstract class AddressBookSystemTest {
    ...
    private static final List<String> COMMAND_BOX_DEFAULT_STYLE = Arrays.asList("text-input", "text-field", CommandBox.SUCCESS_STYLE_CLASS);
    ...
    private void rememberStates() {
        ...
        getDetailsPanel().rememberSelectedPersonDetails();
    }
    ...
    private void assertApplicationStartingStateIsCorrect() {
        try {
            ...
            assertEquals("", getDetailsPanel().getName());
