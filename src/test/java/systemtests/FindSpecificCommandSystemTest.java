...
public class FindSpecificCommandSystemTest extends AddressBookSystemTest {
	private String NAME_PREFIX_WORD = "n/";
	private String PHONE_PREFIX_WORD = "p/";
	private String EMAIL_PREFIX_WORD = "e/";
	private String TAG_PREFIX_WORD = "t/";
	...
	public void find() {
         ...
         * -> 2 persons found
         */
		String command = "   " + FindSpecificCommand.COMMAND_WORD + " " + NAME_PREFIX_WORD + KEYWORD_MATCHING_MEIER + "   ";
		...
		command = "FiNd " + NAME_PREFIX_WORD + KEYWORD_MATCHING_MEIER;
