...
public class ChangeUsernameCommandTest extends AddressBookSystemTest {
    ...
    /**
     * Executes {@code ChangeUsernameCommand} and verifies that the command box displays an empty string, the result
     * display box displays {@code Messages#MESSAGE_PERSONS_LISTED_OVERVIEW} with the number of people in the
     * filtered list, and the model related components equal to {@code expectedModel}.
