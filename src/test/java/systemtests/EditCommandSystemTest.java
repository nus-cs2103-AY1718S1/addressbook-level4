...
public class EditCommandSystemTest extends AddressBookSystemTest {
    ...
    public void edit() throws Exception {
        ...
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased()
                + NAME_DESC_BOB + PHONE_DESC_BOB + BIRTHDAY_DESC_BOB + EMAIL_DESC_BOB
        ...
        selectPerson(index);
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased()
                + NAME_DESC_AMY + PHONE_DESC_AMY + BIRTHDAY_DESC_AMY + EMAIL_DESC_AMY
        ...
        assertCommandFailure(EditCommand.COMMAND_WORD + " "
                        + INDEX_FIRST_PERSON.getOneBased() + INVALID_BIRTHDAY_DESC,
