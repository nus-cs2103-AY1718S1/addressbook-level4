...
public class EditCommandSystemTest extends AddressBookSystemTest {
    ...
    public void edit() throws Exception {
        ...
        String command = " " + EditCommand.COMMAND_WORD + "  " + index.getOneBased() + "  " + ARTICLE_NUMBER_DESC_BOB
                + " " + NAME_DESC_BOB + "  " + PHONE_DESC_BOB + " " + EMAIL_DESC_BOB + "  " + ADDRESS_DESC_BOB + " "
                + TAG_DESC_HUSBAND + " ";
        Parcel editedParcel = new ParcelBuilder().withArticleNumber(VALID_ARTICLE_NUMBER_BOB).withName(VALID_NAME_BOB)
        ...
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + ARTICLE_NUMBER_DESC_BOB + NAME_DESC_BOB
        ...
        index = INDEX_FIRST_PARCEL;
        selectParcel(index);
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + ARTICLE_NUMBER_DESC_AMY + NAME_DESC_AMY
        ...
        assertCommandFailure(EditCommand.COMMAND_WORD + " " + INDEX_FIRST_PARCEL.getOneBased()
                + INVALID_ARTICLE_NUMBER_DESC, ArticleNumber.MESSAGE_ARTICLE_NUMBER_CONSTRAINTS);
