...
import static seedu.address.logic.commands.CommandTestUtil.POSITION_DESC;
...
public class EditCommandSystemTest extends AddressBookSystemTest {
    ...
    public void edit() throws Exception {
        ...
        String command = " " + EditCommand.COMMAND_WORD + "  " + index.getOneBased() + "  " + NAME_DESC_BOB + "  "
                ...
                + POSITION_DESC_BOB + PRIORITY_DESC_BOB;
        Person editedPerson = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            ...
            .withPosition(VALID_POSITION_BOB).withPriority(VALID_PRIORITY_BOB).build();
        ...
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_BOB + PHONE_DESC_BOB
            + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_FRIEND + TAG_DESC_HUSBAND + POSITION_DESC + PRIORITY_DESC;
         ...
         * browser url changes [FAILED TEST CASE]
         */
        showAllPersons();
        index = INDEX_FIRST_PERSON;
        selectPerson(index);
        ...
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_BOB + PHONE_DESC_BOB
            + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_FRIEND + TAG_DESC_HUSBAND + REL_DESC_SIBLINGS;
        assertCommandFailure(command, Relationship.MESSAGE_REL_PREFIX_NOT_ALLOWED);
