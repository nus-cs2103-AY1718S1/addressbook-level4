...
public class EditCommandSystemTest extends RolodexSystemTest {
    ...
    public void edit() throws Exception {
        ...
        command = EditCommand.COMMAND_WORD_ABBREV + " " + index.getOneBased() + NAME_DESC_BOB + PHONE_DESC_BOB
        ...
        index = INDEX_FIRST_PERSON;
        selectPerson(index);
        command = EditCommand.COMMAND_WORD_ABBREV + " " + index.getOneBased() + NAME_DESC_AMY + PHONE_DESC_AMY
        ...
        assertCommandFailure(EditCommand.COMMAND_WORD_ABBREV + " " + INDEX_FIRST_PERSON.getOneBased()
