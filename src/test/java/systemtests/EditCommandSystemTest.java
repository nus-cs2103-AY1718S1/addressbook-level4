...
import static seedu.address.logic.commands.CommandTestUtil.INVALID_REM_TAG_DESC;
...
import static seedu.address.logic.commands.CommandTestUtil.TAG_REM_DESC_FRIEND;
...
public class EditCommandSystemTest extends AddressBookSystemTest {
    ...
    public void edit() throws Exception {
        ...
        String command = " " + EditCommand.COMMAND_WORD + "  " + index.getOneBased() + "  " + NAME_DESC_BOB + "  "
                ...
                + WEB_LINK_DESC + " " + TAG_REM_DESC_FRIEND + " " + PREFIX_CLEAR_TAG;
        ...
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + TAG_ADD_DESC_FRIEND + TAG_ADD_DESC_HUSBAND + WEB_LINK_DESC;
        ...
        index = INDEX_FIRST_PERSON;
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + TAG_REM_DESC_FRIEND + TAG_ADD_DESC_FRIEND
        ...
        assertCommandFailure(EditCommand.COMMAND_WORD + " " + INDEX_FIRST_PERSON.getOneBased() + INVALID_REM_TAG_DESC,
                Tag.MESSAGE_TAG_CONSTRAINTS);
