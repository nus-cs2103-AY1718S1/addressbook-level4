...
public class FindCommandAliasSystemTest extends AddressBookSystemTest {
    ...
    public void findalias2() {
         ...
         * -> 0 persons found
         */
        command = FindCommand.COMMAND_ALIAS2 + " n/Mark";
        expectedModel = getModel();
        ModelHelper.setFilteredList(expectedModel);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();
         ...
         * -> 1 person found
         */
        command = FindCommand.COMMAND_ALIAS2 + " " + PREFIX_NAME + CARL.getName();
        expectedModel = getModel();
        ModelHelper.setFilteredList(expectedModel, CARL);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();
         ...
         * -> 1 person found
         */
        command = FindCommand.COMMAND_ALIAS2 + " " + PREFIX_PHONE + CARL.getPhone();
        expectedModel = getModel();
        ModelHelper.setFilteredList(expectedModel, CARL);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();
         ...
         * -> 1 person found
         */
        command = FindCommand.COMMAND_ALIAS2 + " " + PREFIX_EMAIL + CARL.getEmail();
        expectedModel = getModel();
        ModelHelper.setFilteredList(expectedModel, CARL);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();
         ...
         * -> 1 person found
         */
        command = FindCommand.COMMAND_ALIAS2 + " " + PREFIX_ADDRESS + CARL.getAddress();
        expectedModel = getModel();
        ModelHelper.setFilteredList(expectedModel, CARL);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();
         ...
         * -> 1 person found
         */
        command = FindCommand.COMMAND_ALIAS2 + " " + PREFIX_WEBSITE + CARL.getWebsite();
        expectedModel = getModel();
        ModelHelper.setFilteredList(expectedModel, CARL);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();
         ...
         * -> 1 person found
         */
        command = FindCommand.COMMAND_ALIAS2 + " " + PREFIX_BIRTHDAY + CARL.getBirthday();
        expectedModel = getModel();
        ModelHelper.setFilteredList(expectedModel, CARL);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();
         ...
         * -> 1 person found
         */
        command = FindCommand.COMMAND_ALIAS2 + " " + PREFIX_NAME + "cARL kUrz";
        expectedModel = getModel();
        ModelHelper.setFilteredList(expectedModel, CARL);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();
         ...
         * -> 1 person found
         */
        command = FindCommand.COMMAND_ALIAS2 + " " + PREFIX_NAME + "cArL";
        expectedModel = getModel();
        ModelHelper.setFilteredList(expectedModel, CARL);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();
         ...
         * -> 1 person found
         */
        command = FindCommand.COMMAND_ALIAS2 + " " + PREFIX_NAME + "kUrZ";
        expectedModel = getModel();
        ModelHelper.setFilteredList(expectedModel, CARL);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();
         ...
         * -> 1 person found
         */
        command = FindCommand.COMMAND_ALIAS2 + " " + PREFIX_NAME + "KUr";
        expectedModel = getModel();
        ModelHelper.setFilteredList(expectedModel, CARL);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();
         ...
         * -> 1 person found
         */
        command = FindCommand.COMMAND_ALIAS2 + " " + PREFIX_NAME + "Krz";
        expectedModel = getModel();
        ModelHelper.setFilteredList(expectedModel);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();
         ...
         * -> 1 person found
         */
        command = FindCommand.COMMAND_ALIAS2 + " " + PREFIX_PHONE + "35256";
        expectedModel = getModel();
        ModelHelper.setFilteredList(expectedModel, CARL);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();
         ...
         * -> 0 person found
         */
        command = FindCommand.COMMAND_ALIAS2 + " " + PREFIX_PHONE + "25639535";
        expectedModel = getModel();
        ModelHelper.setFilteredList(expectedModel);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();
         ...
         * -> 1 person found
         */
        command = FindCommand.COMMAND_ALIAS2 + " " + PREFIX_NAME + BENSON.getName() + " "
            + PREFIX_PHONE + BENSON.getPhone();
        expectedModel = getModel();
        ModelHelper.setFilteredList(expectedModel, BENSON);
        assertCommandSuccess(command, expectedModel);
         ...
         * -> 1 person found
         */
        command = FindCommand.COMMAND_ALIAS2 + " " + PREFIX_NAME + "Meier" + " " + PREFIX_PHONE + BENSON.getPhone();
        expectedModel = getModel();
        ModelHelper.setFilteredList(expectedModel, BENSON);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();
         ...
         * -> 2 persons found
         */
        command = FindCommand.COMMAND_ALIAS2 + " " + PREFIX_NAME + "Meier";
        expectedModel = getModel();
        ModelHelper.setFilteredList(expectedModel, BENSON, DANIEL); // first names of Benson and Daniel are "Meier"
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();
        ...
        /* Case: find person in address book, keyword is substring of name -> 2 persons found */
        command = FindCommand.COMMAND_ALIAS2 + " " + PREFIX_NAME + "Mei";
        ModelHelper.setFilteredList(expectedModel, DANIEL, BENSON);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find person in address book, name is substring of keyword -> 0 persons found */
        command = FindCommand.COMMAND_ALIAS2 + " " + PREFIX_NAME + "Meiers";
        ModelHelper.setFilteredList(expectedModel);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find multiple persons in address book, 2 keywords -> 2 persons found */
        command = FindCommand.COMMAND_ALIAS2 + " n/Benson Daniel";
        ModelHelper.setFilteredList(expectedModel, BENSON, DANIEL);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find multiple persons in address book, 2 keywords in reversed order -> 2 persons found */
        command = FindCommand.COMMAND_ALIAS2 + " n/Daniel Benson";
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find multiple persons in address book, 2 keywords with 1 repeat -> 2 persons found */
        command = FindCommand.COMMAND_ALIAS2 + " n/Daniel Benson Daniel";
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find multiple persons in address book, 2 matching keywords and 1 non-matching keyword
         * -> 2 persons found */
        command = FindCommand.COMMAND_ALIAS2 + " n/Daniel Benson NonMatchingKeyWord";
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();
        ...
        ModelHelper.setFilteredList(expectedModel, BENSON, DANIEL);
        assertCommandSuccess(command, expectedModel);
        executeCommand(DeleteCommand.COMMAND_ALIAS2 + " 1");
        assert !getModel().getAddressBook().getPersonList().contains(BENSON);
        command = FindCommand.COMMAND_ALIAS2 + " " + PREFIX_NAME + "Meier";
        expectedModel = getModel();
        ModelHelper.setFilteredList(expectedModel, DANIEL);
        ...
        selectPerson(Index.fromOneBased(1));
        assert !getPersonListPanel().getHandleToSelectedCard().getName().equals(DANIEL.getName().fullName);
        command = FindCommand.COMMAND_ALIAS2 + " n/Daniel";
        ModelHelper.setFilteredList(expectedModel, DANIEL);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardDeselected();
