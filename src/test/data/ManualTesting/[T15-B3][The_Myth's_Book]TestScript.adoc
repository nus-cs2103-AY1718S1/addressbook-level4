...
. `addevent n/Bowling with friends d/20-11-2017 a/` +
Expected result: New reminder added! +
A new reminder would be added to the reminder list.

. `addevent rd/Unique Reminder d/01-02-2017 ti/08:00` +
...
. `addevent rd/ d/12/12/2000 ti/09:00` +
Expected result: +
...
. `addevent rd/Valid reminder 1 d/29/2/2017 ti/18:00` +
...
. `addevent rd/Valid reminder 1 d/31/11/2017 ti/18:00` +
