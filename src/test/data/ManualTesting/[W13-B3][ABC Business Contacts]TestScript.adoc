...
|S2 |login | Browser window opens for Google login
|S3 |sync | Google Contacts will be updated with local contacts
|S4 |logout | Error message: “Logged out!”
|S5 |sync | Error message: “Please login first”
|S6 |logout | Error message: “Failure logging out. Are you sure you are logged in?”
|S7 |Disable your wifi-connection and run sync | Error message: “Unable to connect to the Internet. Please check your internet and firewall settings
”
|=======================================================================
...
| |note -1 Important note| Error message: Invalid command format!
...
|C29 |note 1 | Note Added: Abraham Lionel Phone: No Phone Number Email: abraham@lionel.com Address: No Address Note:  Tags: [colleagues][friend][male] Meetings: [2017-11-20 11:00][2017-11-30 13:00][2017-12-20 11:00]
|C30 |note | Error message: Invalid command format!
note: Modifies a note for the person identified by the index number used in the last person listing.
Parameters: INDEX (must be a positive integer) [NOTE]
...
Example: sort tag
|O19 |sort n| suggestion for `sort name` would pop up
|O20 |sort name | List sorted successfully!
|O21 |sort phone | List sorted successfully!
|O22 |sort tag | List sorted successfully!
|O23 |sort email | List sorted successfully!
|O24 |sort invalid | Error message: Field provided is invalid!
|O25 |undo | Undo success!
...
Parameters: INDEX (must be a positive integer)
Example: select 1”
|M12 |dm 1| Deleted Meeting: Health insurance
|M13 |undo| Undo success!
...
|T6 |deletetag 1 uncle| Deleted Tag: uncle
...
resize: Resize the MainWindows to the specified (300<=)WIDTH(<=1920) and (230<=)HEIGHT(<=1080) Parameters: WIDTH HEIGHT Example: resize 1920 1080’
|Z14 |exit| The application exits
|=======================================================================
