...
. If the XML file at `<BoNUS home folder>/bonus.xml` contains data recognizable by *BoNUS*, this command imports the
data that do not exist in *BoNUS* into the application +
_Command:_ +
`import bonus.xml` +
_Result:_ +
