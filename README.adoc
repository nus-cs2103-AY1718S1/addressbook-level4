...
** Added a delete button to delete selected contacts.
** Unknown commands are now shown with a red "Unknown Command" message in the console.
** Tags can now be colour coded e.g. family = yellow, friends = green.
** Added in remarks for each contact
** Tags can now be filtered
