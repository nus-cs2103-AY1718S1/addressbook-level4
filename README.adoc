...
* Bluebird helps both parent and child manage important contacts, tasks and schedules.
* Bluebird has an in built Child Mode which prevents their child from deleting vital information.
