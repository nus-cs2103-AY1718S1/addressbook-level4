...
https://travis-ci.org/se-edu/addressbook-level4[image:https://travis-ci.org/CS2103AUG2017-F10-B4/main.svg?branch=master[Build Status]]
...
** Able to find person based on additional details.
** Filter persons based on tags.
** Additional options for delete and google maps on each person.
