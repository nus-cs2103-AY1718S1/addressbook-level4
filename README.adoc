...
https://ci.appveyor.com/project/dennaloh/main/branch/master[image:https://ci.appveyor.com/api/projects/status/qkou5km2ggps9knh/branch/master?svg=true[Build status]]
