# aver0214
###### \src\main\java\seedu\address\logic\commands\AddQuickCommand.java
``` java
...
```
###### \src\main\java\seedu\address\logic\commands\FindSpecificCommand.java
``` java
/**
...
```
###### \src\main\java\seedu\address\logic\parser\AddQuickCommandParser.java
``` java
...
```
###### \src\main\java\seedu\address\logic\parser\FindSpecificCommandParser.java
``` java
    /**
...
```
###### \src\main\java\seedu\address\model\person\EmailContainsSpecifiedKeywordsPredicate.java
``` java
    @Override
...
```
###### \src\main\java\seedu\address\model\person\NameComparator.java
``` java
...
```
###### \src\main\java\seedu\address\model\person\PhoneContainsSpecifiedKeywordsPredicate.java
``` java
    @Override
    public boolean test(ReadOnlyPerson person) {
        return keywords.stream()
...
```
###### \src\main\java\seedu\address\model\person\TagContainsSpecifiedKeywordsPredicate.java
``` java
    @Override
    public boolean test(ReadOnlyPerson person) {
...
```
###### \src\test\java\seedu\address\logic\parser\AddQuickCommandParserTest.java
``` java
    @Test
...
```
###### \src\test\java\systemtests\AddQuickCommandSystemTest.java
``` java
