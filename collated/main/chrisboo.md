# chrisboo
###### \java\seedu\address\commons\events\ui\NewAddressBookRequestEvent.java
``` java
 ...
 */
public class NewAddressBookRequestEvent extends BaseEvent {
     ...
     */
    public NewAddressBookRequestEvent(File file) {
