...
Auto-selection of the placeholder will improve user experience, because the user can directly type in information without having to manually place the cursor.
...
* Updated the General Documentation (Pull requests https://github.com/CS2103AUG2017-W11-B2/main/pull/7[#7] https://github.com/CS2103AUG2017-W11-B2/main/pull/22[#22] https://github.com/CS2103AUG2017-W11-B2/main/pull/128[#128])
