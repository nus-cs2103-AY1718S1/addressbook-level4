...
It is written in Java and is built up from the [https://github.com/se-edu/addressbook-level4[AddressBook - Level 4]]. (An address book application used for teaching Software Engineering principles) +
