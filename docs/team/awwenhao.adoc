...
* Impose new restriction for address field by splitting it into block, street, unit and postal code. (Pull request https://github.com/CS2103AUG2017-T15-B2/main/pull/68[#68]) This is an attempt to prevent the user from inputting characters that do not usually appear in addresses.
