...
=== Enhancement Added: Pop-up window reminding user of scheduled activites which are coming soon
...
=== Enhancement of existing feature: Adding a person
...
* Set and created the stylesheet for the user agenda panel
