...
A simple modification for aesthetic purpose. User is able to change theme both on the UI and using command line.
...
* Participated in 1.4 bug tracking (https://github.com/CS2103AUG2017-T17-B3/main/issues/59, https://github.com/CS2103AUG2017-W14-B4/main/issues/115)
