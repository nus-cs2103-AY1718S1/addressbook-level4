...
`history` function is needed for the user to look for any commands that he/she have entered earlier. When the user just added a new person into Rubrika, he/she can use the function to look for the name of the person that have just been added earlier.

---

=== Enhancement Proposed: Add command `history`
...
Format: `history` + up and down arrows will display the previous and next input respectively in the command box.
