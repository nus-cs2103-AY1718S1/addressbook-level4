...
== Purpose
The project portfolio acts as a documentation for the works i have contributed for this project.
...
* Created UI mock up
* Did Acceptance testing for W-13-B3 https://github.com/CS2103AUG2017-W13-B3/main/issues/100