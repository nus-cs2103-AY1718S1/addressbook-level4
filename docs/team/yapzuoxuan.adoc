...
*Code contributed*: [https://github.com/CS2103AUG2017-T10-B2/main/blob/master/collated/main/wishingmaid.md[Functional code]] [https://github.com/CS2103AUG2017-T10-B2/main/blob/master/collated/test/wishingmaid.md[Test code]] {give links to collated code files}
