...
is a need to limit the number of available commands that the child is able to sue.
...
* Added Bluebird result image when inputting commands (Pull requests https://github.com/CS2103AUG2017-T15-B4/main/pull/143[#142],
