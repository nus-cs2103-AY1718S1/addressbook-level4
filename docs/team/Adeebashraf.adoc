...
*Code contributed*:
https://github.com/CS2103AUG2017-W10-B3/DeathNote/tree/master/src/main/chilipadiboy.md[Functional code]
https://github.com/CS2103AUG2017-W10-B3/DeathNote/tree/master/src/test/chilipadiboy.md[Test code]
