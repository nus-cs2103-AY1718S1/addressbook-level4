...
=== Enhancement: Convert inputted names to become capitalized fully(Upper CamelCase)

Code on GitHub: Pull requests https://github.com/CS2103AUG2017-T15-B3/main/pull/123/commits/cf57e5e78374ec3ee69125e8342ed27c9efa06da[#123]
