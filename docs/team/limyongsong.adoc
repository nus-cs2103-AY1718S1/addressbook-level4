...
Updated the GUI color scheme (Pull requests https://github.com/CS2103AUG2017-T09-B4/main/pull/104[#104]) +
Add colours to tags (https://github.com/CS2103AUG2017-T09-B4/main/pull/6[#6]) +
