...
*Code contributed*: [https://github.com/jo-lyn/Rolodex/blob/collate/collated/main/jo-lyn.md[Functional code]] [https://github.com/jo-lyn/Rolodex/blob/collate/collated/test/jo-lyn.md[Test code]]
...
---
=== Other contributions
* Added auto-selection to person that is newly edited (Pull request https://github[#102])
* Added auto-selection to person that is newly added (Pull request https://github[#123])
