...
It would be a convenient feature for debt collectors to have their debt collectors debts automatically updated.
...
A more updated version will be included in V2.0.
