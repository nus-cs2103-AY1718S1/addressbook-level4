...
* Minor changes to improve readability of code, as per Codacy's recommendations.
* Fixed typecasting errors that were causing -Xlint warnings to appear upon compilation.
