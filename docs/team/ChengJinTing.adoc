...
=== Enhancement Proposed: Auto suggestion of contact's attributes when using FindCommand

==== Justification

To allow a faster way for user to find their contacts without having to ensuring full word match
