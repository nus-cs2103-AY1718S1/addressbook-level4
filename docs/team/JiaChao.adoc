...
* Set up Travis and Coveralls and updated Badges for the Team Repository ( Pull Requests https://github.com/CS2103AUG2017-T16-B2/main/pull/7[#7] )
* Populated cherBook with a significant amount ( 40 student contacts) of realistic data ( Pull Requests https://github.com/CS2103AUG2017-T16-B2/main/pull/73[#73] )
