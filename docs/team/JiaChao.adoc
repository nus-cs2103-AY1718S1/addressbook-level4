...
* Added Travis and Coveralls on the cherBook repository automated deployment and testing. (Pull Request https://github.com/CS2103AUG2017-T16-B2/main/pull/7[#7])
