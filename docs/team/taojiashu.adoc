...
* UI enhancement on how `Favourite` is diaplayed (Pull requests https://github.com/CS2103AUG2017-W13-B1/main/pull/69[#69], https://github.com/CS2103AUG2017-W13-B1/main/pull/78[#78])
