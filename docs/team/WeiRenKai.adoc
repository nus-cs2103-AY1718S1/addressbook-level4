...
[https://github.com/CS2103AUG2017-F10-B4/main/blob/master/collated/test/renkai91.md[Test code]] {give links to collated code files}
...
include::../UserGuide.adoc[https://github.com/CS2103AUG2017-F10-B4/main/blob/master/docs/UserGuide.adoc]
...
Adding birthday to person list of Mybook in the command box when they are filling up information. This
allows the user to identify who's birthday is coming up, so that they can celebrate their birthday.
...
include::../DeveloperGuide.adoc[https://github.com/CS2103AUG2017-F10-B4/main/blob/master/docs/UserGuide.adoc]
