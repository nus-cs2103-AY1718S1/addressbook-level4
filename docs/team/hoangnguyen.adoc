...
* Add additional Profile Panel to Main Window to view contact details (Pull requests https://github.com/CS2103AUG2017-T10-B4/main/pull/85[#85])
* Wrote additional tests to increase coverage (Pull requests https://github.com/CS2103AUG2017-T10-B4/main/pull/112[#112], https://github.com/CS2103AUG2017-T10-B4/main/pull/62[#62])
