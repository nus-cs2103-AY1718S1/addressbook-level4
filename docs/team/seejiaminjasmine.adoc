...
ConnectUs aims to give convenience while being user-friendly. By having a feature to filter the contacts based on the tags,
...
The theme can be changed by clicking on the `File` drop down menu and selecting the theme. This is to make it user-friendly and
easier for users to change the colour theme as the colour themes are all listed in the menu and they can directly change the colour theme by simply clicking instead of
having to type in the command line and searching for what available colour themes are there.
