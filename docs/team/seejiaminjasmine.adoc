...
editing details of a contact, uploading photo to a contact and generating a QR code to scan the chosen contact's number on the phone for easy calling and messaging of the contact on the phone.
...
The theme can be changed by clicking on the `File` drop down menu and selecting the theme or through the command line interface.  +
