...
Contact book is a desktop address book application designed for University students. The user interacts with it using a CLI, and it has a GUI created with JavaFX. It is written in Java, and has about 8 kLoC.

*Code contributed*: [https://github.com/CS2103AUG2017-T14-B1/main/blob/master/collated/main/LuLechuan.md[Functional code]] [https://github.com/CS2103AUG2017-T14-B1/main/blob/master/collated/test/LuLechuan.md[Test code]]
...
include::../DeveloperGuide.adoc[photo]
