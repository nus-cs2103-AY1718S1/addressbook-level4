...
* Added Meeting Tags for meeting cards to indicate importance of meeting. (Pull requests )
* Added Junit Test cases (Pull requests )
* Updated ui of Meeting List (Pull requests )
