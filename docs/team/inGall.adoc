...
It demonstrates the mechanism behind the features implemented and provide insights to users on how to use the product.
It also provides justification to why these features are implemented.
