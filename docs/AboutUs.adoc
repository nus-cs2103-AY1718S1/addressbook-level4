...
=== Zhou Kai
image::Zk_pic.png[width="150", align="left"]
{empty}[http://github.com/zhoukai07[github]] [https://www.linkedin.com/in/zhoukai91/[linkedin]][<<zhoukai#, portfolio>>]

Role: Team Member
Responsibilities: UI, Product Manager Wannabe :)
