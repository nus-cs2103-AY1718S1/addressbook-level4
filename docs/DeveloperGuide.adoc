...
.  Technical requirements: The Addressbook should be able to work on both 32 and 64 bit system
.  Performance requirements: The Addressbook should be able to give a response within 1 second
.  Security requirements: The Addressbook should be able to hide personal
   information using a password
.  Quality requirements: The Addressbook should be simple enough for a novice who does not use an addressbook before to use
.  Privacy requirements: The Addressbook data should only be read and modified by authorized party
