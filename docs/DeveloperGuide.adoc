...
|`* * *` |As a user |add a person with link:#blank-information[blank information] |add him even if I do not know some details (e.g his address)
...
* 1a. User presses F1 on the keyboard
+
Use case resumes at step 2.

* 1b. User clicks on help icon
+
