...
=== First time tutorial
Currently when new users launch Bluebird for the first time, they will be lost as to what Bluebird has to offer and also
what different UI panels mean. Therefore, there is a need to provide first time users of Bluebird
a step-by-step tutorial on how Bluebird works.
