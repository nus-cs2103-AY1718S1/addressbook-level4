...
image::birthdayLogic.png[width="700"]
...
image::birthdaySD.png[width="800"]
...
The 4 advanced find commands, as well as the basic `find` oommand lies in the `commands` of `Logic`. and does not deal
...
image::findPhoneSD.png[width="800"]
...
* Only full words will be matched (e.g. "8123" will not match "81234567").
