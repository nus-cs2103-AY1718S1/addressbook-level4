...
|`* * *` |user |list and view all my contacts |
...
|`* * *` |user |view the history of the commands inputted |
...
|`* * *` |user |clear entries in my addressbook |
...
|`* * *` |user |access Facebook, LinkedIn and Google |search and add my contacts on respective websites

|`* * *` |user |have a confirmation request of the details inputted before adding an individual|make changes to any errors inputted

|`* * *` |user |have a confirmation request & warning message upon using the clear command |avoid accidentally clearing my address book

|`* * *` |user |find contacts based on part of their names |
...
|`* * *` |user |sort my contacts in an alphabetical order |view my overall contact list alphabetically

|`* *` |user |hide link:#private-contact-detail[private contact details] by default |minimize chance of someone else seeing them by accident

|`* *` |user |have directions to the contact's address with Google Maps from current location |

|`* *` |user |choose various colour themes for the address book |view the address book in my favourite visuals

|`* *` |user |add some important people to a favourites list |access my favourite contacts easily

|`* *` |user |see my most viewed contacts on a "speed check" tab |search quickly for contacts that i often search for based on the number of times i searched for them

|`* *` |user |sort the list of contacts based on their details |view contacts based on my preferable detail i am wishing to search for

|`* *` |user |save my contacts list in a portable format |keep a soft copy of it and be able to retrieve if i lost my original contact list or want to access it in another computer

|`* *` |user |add organisations/groups |search for individuals based on their organization groups

|`* *` |user |store internet links to their organization website, github, instagram or facebook |more information on my contacts

|`* *` |user |have the option to add a picture of an individual |recognize contacts by their facial features.

|`* *` |user |get reminders |know if i am attending an event with another contact, or if it is the contact's birthday

|`* *` |user |be able to create appointments with my contacts |be notified of my upcoming meetings

|`* *` |user |add birthday information to my contact in the address book |
