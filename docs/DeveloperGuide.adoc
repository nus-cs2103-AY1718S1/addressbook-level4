...
The event mechanism will facilitated by `EventBook`, which resides inside `ModelManager`. It supports the additional
feature of event management, which allows the user to add, edit, delete, or find event.
