= Contact List Pro v1.3 - Developer Guide
:toc:
:toc-title:
...
Contact List Pro is a software address book that allows users to store contacts and manage them using a variety of features.
This guide provides information for you to set up and get started as a Contact List Pro developer, and is detailed enough to be useful to experienced developers as well.
