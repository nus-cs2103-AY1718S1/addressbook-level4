...
|`* * *` |user |list contacts in alphabetical order |find a contact by the first letter of their name
...
|`* *` |user |send selected contacts with others |share them without others having to type it in
...
|`* *` |OTG user |access addressbook on multiple platforms and sync my data |have my contacts close at hand from anywhere
