...
2. AddressBook processes the information and adds the person to the list.
+
Use case ends.
...
+
[none]
** 2a1. AddressBook shows an error message and displays a sample input.
+
...
2. AddressBook locates that specific person.
3. User provides new information of that person.
4. AddressBook updates the person with the information provided.
+
Use case ends.
...
+
[none]
** 3a1. AddressBook shows an error message and displays a sample input.
+
Use case resumes at step 1.
...
2. AddressBook processes the information and lists every person with the name.
+
Use case ends.
...
+
[none]
** 2a1. AddressBook prompts a message.
+
Use case ends.
...
2. AddressBook selects the person with that index number in the current list order.
+
Use case ends.
...
+
[none]
** 2a1. AddressBook displays an error message and prompts a sample input format.
+
Use case ends.
...
2. AddressBook displays a list of every person stored.
+
Use case ends.
...
2. AddressBook reverses the changes the last command causes and displays a success message.
+
Use case ends.
...
+
[none]
** 2a1. AddressBook displays a failure message.
+
Use case ends.
...
2. AddressBook re-execute the last command before the undo command and displays a success message.
+
Use case ends.
...
2. AddressBook returns a list of commands entered from the most recent to the earliest.
+
Use case ends.
...
+
[none]
** 2a1. AddressBook displays a message.
+
Use case ends.
...
2. AddressBook deletes everything that has been stored.
+
Use case ends.
...
1. User requests to get help with using AddressBook.
2. AddressBook opens the user guide.
+
Use case ends.
