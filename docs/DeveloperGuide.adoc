...
|`* * *` |debt collector |have an automated interest calculator |have my debtors' debts updated automatically

|`* * *` |debt collector |group my debtors by location |plan my visit schedules easily

|`* * *` |debt collector |have a password protection to my account |have some security over confidential information

|`* *` |debt collector |have an automated journey scheduler |maximise my efficiency
...
|`* *` |user |be able to link:#bookmark[bookmark] contacts |access important contacts much faster
...
....
A list of desirables wanted or needed by a contact for his or her birthday
....
...
Author: Jessica Ryans, Leslie Murray
...
Authors: Becca Malard & Susan Starrett
