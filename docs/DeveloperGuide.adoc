...
* If the input is already in the required format of the add command, the kbd:[Tab] is meant to navigate to the next input field (only `add` command require multiple fields).
