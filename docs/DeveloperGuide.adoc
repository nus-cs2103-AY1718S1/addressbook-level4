...
image::SDforListByBloodtypeCommandLogic.png[width="800"]
    Figure 21: ListByBloodyTypeCommand Sequence Diagram
...
image::SDforBatchDeleteLogic.png[width="800"]
    Figure 22: Sequence diagram for a `batch myTag` command in the Logic Component
...
image::SDforBatchDeleteModel.png[width="800"]
    Figure 23: Sequence diagram for a `batch myTag` command in the Model Component
