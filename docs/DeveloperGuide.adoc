...
Figure 5.5.1 Switch Theme Command Diagram
...
As seen in the diagram below, when `themes` is executed in `ThemeListCommand`, it will post `ShowThemeRequestEvent` to the `EventsCenter`.
