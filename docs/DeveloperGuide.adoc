...
ws selected. Static variables to track which card has been selected has been added to the Model
...
we have selected a parcel card and we will then re-select that card after we have sorted. +
