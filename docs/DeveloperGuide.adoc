...
As you've might have noticed in the diagram, a foreign-looking class is used – namely, `Clipboard` and `ClipboardContent`.
These classes allow you to intuitively visualise how MedNus interacts with the system clipboard. Check out the
