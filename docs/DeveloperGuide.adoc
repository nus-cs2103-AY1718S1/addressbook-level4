...
_Figure 5.2.2 Email Request Event Sequence Diagram_
...
_Figure 5.4.2 Export Activity Diagram_

image::vCardClassDiagram.png[width="800"]
_Figure 5.4.1 Vcard Class Diagram_
