...
The following is a sequence diagram detailing the process of how `sort` instruction is handled by Rubrika after the `SortCommandParser` has been created. And how `UI` component is able to display the sorted list. +
