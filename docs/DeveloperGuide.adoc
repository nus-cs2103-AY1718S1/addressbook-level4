...
_Figure 1: The Architecture Diagram below explains the high-level design of the App._
...
_Figure 2: UML diagram of the UI Component showing how it is structured_
...
_Figure 5: Interactions *between components* for a `delete 1` command_

image::SDforDeletePerson.png[width="800"]

_Figure 6: Interactions *within the Logic Component* for the `delete 1` Command_
...
_Figure 8: Structure of the Storage Component_
...
_Figure 9: Logic Command Class Diagram_
...
_Figure 10: Undo Redo Starting Stack Diagram_

image::UndoRedoStartingStackDiagram.png[width="800"]

As the user continues to use the program, more commands are added into the `undoStack`. For example, the user may execute `add n/David ...` to add a new person.

_Figure 11: Undo Redo New Command Stack Diagram_
...
_Figure 12: Execute Undo Stack Diagram_
...
_Figure 13: Undo Redo Sequence Diagram_
...
_Figure 14: Undo Redo New Command Stack Diagram 2_

image::UndoRedoNewCommand2StackDiagram.png[width="800"]

Commands that are not undoable are not added into the `undoStack`. For example, `list`, which inherits from `Command` rather than `UndoableCommand`, will not be added after execution:

_Figure 15: Undo Redo New Command Stack Diagram 3_
...
_Figure 16: Undo Redo Activity Diagram_
...
_Figure 17: Sequence diagram for `add appointment` Model Component_
...
_Figure 18: Sequence diagram for `add appointment` Model Component_
...
_Figure 19: List Package Activity Diagram_
...
Implementation passes through two main segments: Logic and Model. +
 +
The explanation as follows will use ListByTag Command as an example: +
...
_Figure 20: ListByBloodyTypeCommand Sequence Diagram _
...
_Figure 21: Sequence diagram for a `batch myTag` command in the Logic Component_
...
_Figure 22: Sequence diagram for a `batch myTag` command in the Model Component_
