...
=== Playing Music
Unify has a built-in background music player. Users have the choice of playing some music to relax their mind and reduce their stress.
...
.  Text to Speech and Speech to Text features should work on Windows 10.
...
.  Should be link:#portable-app[portable] and easily transferable.
...
Singleton
 +
link:https://en.wikipedia.org/wiki/Singleton_pattern[Wikipedia Article]
....
