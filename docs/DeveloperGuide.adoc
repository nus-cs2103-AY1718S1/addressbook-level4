...
One consideration for the chosen mechanism is that backup should aid during crisis, such as data corruption or lost. Hence, backup the entire file is the safest choice for administrator staffs
