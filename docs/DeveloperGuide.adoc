...
_Figure 2.4.1 : Structure of the Components related to LifeInsurance_
...
_Figure 2.4.1 : Structure of the Components related to XmlAdaptedLifeInsurance_
...
The following sequence diagram shows how the add life insurance operation works:

image::AddLifeInsuranceCommandSequenceDiagram.png[width="800"]

There are eight compulsory fields required for the user to input in the add life insurance command.
They are: name, owner, insured, beneficiary, premium, signing date, expiry date, and contract file name.
