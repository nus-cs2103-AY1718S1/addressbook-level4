...
2. User enter the category (i.e. name/address/tag/phone) and details to search for person
...
[none]
* 2a. The category enter is invalid.
+
** 2a1. AddressBook shows an error message.
** 2a2. AddressBook prompts user to enter from a list of category.
