...
_Figure 3.8.1a : Sequence Diagram of Remark command_
...
* You can obtain the `Logger` for a class using `LogsCenter.getLogger(Class)` which will log messages according to 
