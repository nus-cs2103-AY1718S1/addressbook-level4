...
|`* *` |user |add link:#relationship-name[names to relationship] between people |show that two persons know each other via a specific method

|`* *` |user |add link:#confidence-estimate[confidence estimate] to a relationship |differentiate between verified and unverified pieces of information
