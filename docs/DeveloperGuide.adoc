...
This means when adding a new person in LISA, the user only need to provide value for the compulsory `NAME` field. Every other field is optional.
...
If the phone tag is not provided, e.g. `add n/John Doe`, the no-argument constructor is used.
