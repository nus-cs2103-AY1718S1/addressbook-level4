...
you have to type out the full name in order to be able to find the `Person`. +

The enhanced find feature allows you to find the `Person` you want using their name, phone, email, address or tag. Keywords need not be typed in full and partial keywords will still be able to find the `Person`
