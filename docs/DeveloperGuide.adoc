...
This predicate is compared against contacts in the address book, so as to generate a list of potential duplicate contacts.
At the moment, contacts are considered potential duplicates if they share the same name (case-insensitive) with any other contact in the address book.
