...
|`* *` |security-concerned debt collector |have link:#2FA[2FA] authentication for login and every other important action(exporting contacts) |ensure that no one else is capable of accessing sensitive information
...
....
Refers to the clients that have paid off all their debts (in this context)
....
