...
**Aspect:** Auto-completion binding +
...
The link:#shortcut[Keyboard Shortcut Mechanism] is the foundation of this implementation.
...
Other improvements made to the UI include the following features:
