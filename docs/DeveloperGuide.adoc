...
When the `remark` command is used, a new note will be created and linked to a module. +
The `handleRemarkChangedEvent()` will then generate the stickynotes view and set it as visible. +
