...
Since our target audience are the NUS students, which include a large proportion of international students, our addressBook will support the users to add multiple phone numbers.
=======
...
The 3 parameters represents the index of the person in the AddressBook, action to be taken (add/remove/showAllPhones) and a value respectively.
