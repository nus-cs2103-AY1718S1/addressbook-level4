...
Trouble arises with different tabs. Now the `add` and `edit` command changes the state of the parcels
and they are to be selected upon execution. With tab switches, and active lists, it is crucial that
we manipulate the various witches. +
