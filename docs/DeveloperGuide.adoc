...
|`* *` |user |add named relationships between people |show that two persons know each other via a specific method

|`* *` |user |add confidence estimates to a person's attributes |differentiate between verified and unverified pieces of information
...
|`* * *` |user |see the network of relationships between people |visulaise connections and groups in the network

|`* *` |user |display relationships only above a certain confidence value |find a more confident way to know a person
...
|`* *` |user |update the confidence estimate on a person's attributes |update confidence in pieces of information
...
|`* *` |user |remove confidence estimates from a person's attributes |remove unneeded confidence estimates
...
|`* *` |user with many persons in the address book |hide details by default, and only show full details when I select a particular contactn |have a less-cluttered address book
...
|`* *` |advanced user |type shorter command aliases |do operations faster
|=======================================================================
