...
[NOTE]
If we find duplicate people when restoring a person to recyclebin or moving a person to addressbook, then this person will be omitted and directly remove.
