...
The following method receives tagName (description of the tag) as a String input and returns a HashMap
...
_Figure 4.4.1 : Valid Displayed Person Card Phone Information_
