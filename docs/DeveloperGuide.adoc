...
Whenever an action such as "Add", "Clear", "Delete", "Edit", "Email", "Import", "List", "Redo", "RemoveTag", "Undo", "UploadPhoto", "DeletePhoto" & "DeleteAllPhotos" is executed, the LoggingCommand method will be called and information of the action is recorded in ConnectUsLog.txt with a timestamp.
...
_Figure 4.16.1 : Sequence Diagram of the QrSmsCommand_
...
_Figure 4.17.1 : Sequence Diagram of the QrSaveContactCommand_
