...
Figure 5.2.1 Events Command Diagram 1
...
Figure 5.3.1 AddEventCommand Logic Class Diagram
...
_Figure 5.4.1 Delete Event Command Diagram_
...
_Figure 5.4.2 Delete Event Command Diagram 2_
...
_Figure 5.4.3 Delete Event Command Diagram 3_
...
_Figure 5.4.4 Delete Event Command Diagram 4_
...
_Figure 5.5.1 Switch Theme Command Diagram 1_
...
_Figure 5.5.2 Switch Theme Command Diagram 2_
...
_Figure 5.5.3 Switch Theme Command Diagram 3_
...
_Figure 5.6.1 Theme List Command Diagram 1_
...
_Figure 5.6.2 Theme List Command Diagram 2_
...
_Figure 5.6.3 Theme List Command Diagram 3_
...
_Figure 5.11.1 Find Tag Command Diagram 1_
...
_Figure 5.12.1 Favourite Command Diagram 1_
...
_Figure 5.12.2 Favourite Command Diagram 2_
...
_Figure 5.13.1 Favourite List Command Diagram 1_
...
_Figure 5.13.2 Favourite List Command Diagram 2_
...
The  panel is directly accessed by `MainWindow` class. The `details panel` class extends from `UiPart<Region>` and calls the super class constructor to use the FXML file.

It also calls the `loadBlankPage()` method in its constructor so that the user does not see anything on the details panel when the application is first opened.
...
The sequence diagram is shown in 5.18.1 below.

image::DetailsPanelMechanism.png[width="800"]
Figure 5.18.1 Details Panel Sequence Diagram
