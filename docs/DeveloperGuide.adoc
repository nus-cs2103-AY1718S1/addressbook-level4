...
By: `F10-B2`      Since: `Sep 2017`      Licence: `MIT`
...
*Cons:* Might have to change a lot of components if want to add a username in
...
4. AddressBook sorts contacts by name
+
Use case ends.
...
2. AddressBook opens a new help window
+
Use case ends.
