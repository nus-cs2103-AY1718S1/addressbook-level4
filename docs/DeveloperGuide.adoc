...
launch the default mail application registered on users' native desktop. A `URI` instance has to be created and pass to the mail method in the `Desktop` class.
...
===== Design Considerations
**Aspect:** Where to implement this feature +
...
4) The user is searching for a particular birthday month, +
