...
Rolodex is a desktop rolodex application. It is catered to computing professionals who prefer working without a mouse to manage their contacts more efficiently.
