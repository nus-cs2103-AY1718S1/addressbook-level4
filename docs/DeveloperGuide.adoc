...
* Remember to check the status of the stream URLs. As it is possible but highly unlikely that one of those radio broadcast has shut down.
// end::radiocommand[]
