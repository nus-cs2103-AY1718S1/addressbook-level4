...
The import mechanism is essentially adding multiple Residents to the ResidentBook automatically by referencing an external xml file. It is implemented by calling add function repeatedly till all the new Residents have been added to the current ResidentBook.
