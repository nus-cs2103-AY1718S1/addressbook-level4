...
|`* * *` |careless user| undo/redo previous command |

|`* * *` |user |add/delete tags without overriting/rewriting the entire tag list |
...
|`*` |efficiency user| load multiple addressbooks | have different book for different purpose

|`*` |experienced user| write multiple command in a single line| shorten typing time
