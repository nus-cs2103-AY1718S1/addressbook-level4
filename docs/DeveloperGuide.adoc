...
.  Should not experience visible lag or delays above 0.5s when running any command within the addressbook.
.  Should display a pleasing image when working in offline mode.
.  Core functionality should not be affected by the connectivity of the computer.
