...
|`* * *` |teacher |add new location for a module in timetable |I can plan my teaching schedule
...
|`* * *` |teacher |view available slots at a specified location |I can determine if i should schedule my lecture there

|`* * *` |teacher |login with my username/password |I can gain access to the product
...
|`* * *` |student |view all modules taught by a lecturer |I can make my study plan

|`* *` |admin |list a particular lecturer |I no need to search manually in the list of teachers
