...
For the Logic component, `HelpCommandParser` has been created to parse user input that follows the `help` command word. Refer to the code section in _Figure4.3.2_ below to understand how it is implemented.
...
----
_Figure 4.2.4 : Code section from CommandResult.java_
...
**Alternative 2:** Both DD-MM and DD-MM-YYYY are acceptable date format.  +
...
**Cons:** The user receive an error message if they input non-unique indices.
