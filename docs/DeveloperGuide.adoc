...
|`* * *` |user |edit contact's details |update contact's details without creating a new contact
...
|`* *` |user |search contacts using other fields |easily find intended contact without knowing the name

|`* *` |user |delete contact using other fields such as name |delete contact without knowing the index number
...
7.  User needs to type in password every time at start before user can use any commands, other than help
+
Use case ends.
...
* 7a. User type wrong password
+
** 7a1. AddressBook reveals first and last letter of password.
+
** 7a2. User has forgotten the password
+
** 7a3. AddressBook prompts user to check the .xml that stores the password
+
...
.  A user should only be able to enter a certain amount of words into the command line
