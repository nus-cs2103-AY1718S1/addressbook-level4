...
==== Open-Closed Principle (OCP)
 Open-Closed Principle (OCP): A module should be open for extension but closed for
 modification. That is, modules should be written so that they can be extended,
...
Figure 3.4.1: Logic of SortCommand
...
Figure 3.4.2: Sequence diagram for sorting by name
...
Figure 3.4.3: Sequence diagram for SortCommand executeUndoableCommand()
