...
This developer guide provides future contributors and maintainers of cherBook with the necessary information for understanding
the cherBook source code and guidelines for contributing to the repository.
Such information includes cherBook's software architecture, Components and their APIs, documentation and contributing guidelines.
