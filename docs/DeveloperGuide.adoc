...
The sequence diagram in _Figure 4.4.4_ below shows how the find function works:

image::SequenceDiagramFind.PNG[width="800"]
_Figure 4.4.4 : Find sequence diagram_


Upon any successful match, the particulars of the contact will be displayed in `CommandBox`. _Figures 4.4.5a to 4.4.5g_ below indicate the various outcomes of search function by  using `FindCommand`.

image::FindCommand_Name.PNG[width="400"]
_Figure 4.4.5a : Find by name [n/NAME]_

image::FindCommand_Phone.PNG[width="400"]
_Figure 4.4.5b : Find by phone [p/PHONE]_

image::FindCommand_Email.PNG[width="400"]
_Figure 4.4.5c : Find by email [e/EMAIL]_

image::FindCommand_Address.PNG[width="400"]
_Figure 4.4.5d : Find by address [a/ADDRESS]_

image::FindCommand_Activity.PNG[width="400"]
_Figure 4.4.5e : Find by activity [act/ACTIVITY]_

image::FindCommand_Tag.PNG[width="400"]
_Figure 4.4.5f : Find by tag [t/TAG]_

image::FindCommand_Country.PNG[width="400"]
_Figure 4.4.5g : Find by country [c/COUNTRY]_
