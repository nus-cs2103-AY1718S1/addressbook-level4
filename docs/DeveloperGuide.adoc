...
The backing up of DummyName is done by `BackupCommand` and the restoring of data from a backup file is done by `RestoreBackupCommand`.
...
[NOTE]
A backup of the data is automatically created when *DummyName* is closed.
