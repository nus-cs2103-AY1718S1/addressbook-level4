...
2.  BlueBird prompts user to enter multiple names to delete: del name1 name2 .. etc
3.  BlueBird displays message for successfully removing contact(s) from memory
+
Use case ends.
