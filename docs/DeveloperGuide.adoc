...
List feature is a useful feature to view persons of a certain category. In the context of this project, master list contains all the contacts of the debt collection agency. As the need to categorize people into the respective groups was necessary, we implemented a new way to obtain this.
...
The following sequence diagram, Figure 3.2.1, shows further details of the interaction between the user and various application components as a whole, when the blacklist command is executed:

image::BlacklistCommandSequenceDiagram1.png[width="800"]
Figure 3.2.1 : Sequence Diagram of How the Blacklist Command Works_

The following sequence diagram, Figure 3.2.1, shows further details of the interaction between `Model` and 'Addressbook` to obtain the blacklist:

image::BlacklistCommandSequenceDiagram2.PNG[width="800"]
Figure 3.2.2 : Sequence Diagram of Model and Addressbook Interacts To Generate The Blacklist From All Persons_
...
**Cons:** Implementation is complicated and ever changing whenever new commands are introduced.
