...
Suppose the user has just executed the ChangeMode using switch addressbook(ab) or taskmanager(tm).
...
Suppose the user has just executed the `FindCommand` using `find friends`.
...
Suppose the user has just executed the `add` command using `add CS assignment from 15-10-2017 to 20-10-2017`.
...
Suppose the user has just executed the `delete` command using `delete 2`.
...
Suppose the user has just executed the `FindTaskCommand` using `find finish cs2103 17-07-1995`.
...
Suppose the user has just executed the `ListTaskCommand` using `list`.
...
Suppose the user has just executed the `SelectTaskCommand` using `select`.
