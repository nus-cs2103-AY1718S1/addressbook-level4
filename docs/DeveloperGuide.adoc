...
|`* * *` |user |add or delete multiple users in one go |I can save time by not repeating commands
...
[discrete]
=== Use case: Merge duplicate contacts

*MSS*

1. User requests to list duplicate contacts
2. Addressbook displays a list of contacts with the exact same information
3. User selects duplicate contacts to merge using index.
4. Addressbook merges contacts.
+
Use case ends.
...
[none]
* 2a. The list contains contacts with the same information but with some duplicate fields, some missing and others extra.
+
[none]
** 2a1. User selects contacts to merge.
+
