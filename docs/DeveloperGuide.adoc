...
In addition, the person is associated with a list of tags, we need to eliminate them when we undo. +

.The whole process is following:
.. When we add a person to addressbook:
