...
**Cons:** There is no way to obtain the original list of contacts for other functions. If a mistake is made, the original list of contacts will be compromised. There is a need to update all classes that inherits from `AddressBook` which may be confusing.
...
|`* * *` |user |edit my friends' contact on UniCity |
