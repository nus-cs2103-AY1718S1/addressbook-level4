...
The IsGenderSet variable is specified to know if the user has entered the gender of the entry
...
----
As the value above specified by the user is empty , we make sure to set the IsGenderSet variable
to False.
