...
|`* * *` |frequent user |save contacts locally |don't have to load files each time I exit and re-open the application
...
|`* * *` |travelling user |load my contacts from file |use the app on all my devices
...
*Precondition: Person in question should be saved with 'add' in addressbook*
...
2.  AddressBook shows a list of persons with name entered
3.  User selects the index of specific person
4.  AddressBook shows full contact details of person
+
Use case ends.
...
2.  AddressBook lists the commands entered in reverse order
...
2.  AddressBook shows the instructions of the command entered
3.  User views help window
+
Use case ends.
...
1.  User requests to find one or more person(s) in AddressBook
2.  AddressBook shows a list of persons with the name(s) specified by user
+
Use case ends.
...
3.  AddressBook displays message for successfully adding a person along with the person's details
+
Use case ends.
...
+
[none]
** 1a1. AddressBook shows an invalid format message and displays the right format to user.
+
...
2.  AddressBook shows a list of person(s) with the tag specified by user
+
Use case ends.
...
[none]
* 2a. 0 person with such tag
+
Use case ends.

[discrete]
=== Use case: Hide Selected Contacts

*MSS*

1.  User requests to a contact with the command: hide
2.  With hide, AddressBook does not show hidden contacts
3.  Hidden contacts will not show even when search command is invoked
4.  User can check what he has hidden with: check hidden
5.  User can undo hidden contacts with command: unhide
6.  AddressBook displays message for successfully hiding contact(s) from view.
+
Use Case ends.
...
[none]
* 3a. AddressBook will show contacts that user has hidden in chronological order (reverse from present)
+
Use case ends.

[none]
* 4a. User can undo hiding, similar to extension steps 1a, 1b, 1c, with command: unhide
+
Use case ends.
...
*Precondition: Some contacts in user's AddressBook memory has to already have tags under their contact details. Tags could be dates, association/organisation names etc.*

*MSS*

1.  User requests to sort contacts by command: sort exampleOfTag1 exampleOfTag2
2.  AddressBook displays contacts that have the respective tag(s) under their contact details as initially edited by user.
+
Use case ends.
...
1.  User requests to delete multiple contacts with command: del >1
2.  AddressBook prompts user to enter multiple names to delete: del name1 name2 .. etc.
3.  Or user can choose to select names from AddressBook GUI to delete
4.  AddressBook displays message for successfully removing contact(s) from memory.
+
Use case ends.
...
+
[none]
** 2a1. AddressBook will check which name is non-existent (due to incorrect spelling or actually non-existent)
+
[none]
** 2a2. AddressBook will prompt user to check accuracy of that particular contact name and re-enter if necessary.
+
[none]
...
5. AddressBook returns person's details for user to edit.
...
....
An Application Programming Interface (API) specifies the interface through which
other programs can interact with a software component. It is a contract between the
...
....
Continuous Integration (CI) is an extreme application of build automation in
which integration, building, and testing happens automatically after each code change
....
