...
:repoURL: https://github.com/T16-B1/addressbook-level4/tree/master
...
.  Hash string of the users personal contact information should be at most 10 characters long.
