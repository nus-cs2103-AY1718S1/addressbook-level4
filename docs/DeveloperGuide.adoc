...
|`* *` |security-concerned debt collector |have link:#2-FA[2-FA] authentication for login and every other important action(exporting contacts) |ensure that no one else is capable of accessing sensitive information
...
* 1b. The user enters the wrong format into Codii.
+
[none]
