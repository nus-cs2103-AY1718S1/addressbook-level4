...
|`* *` |user |be prompted for confirmation when clearing the address book |avoid accidentally clearing the address book

|`*` |user with many persons in the address book |sort persons by name |locate a person easily

|`*` |user with many persons in the address book |delete a person using their name |remove a contact without having to find their index
