...
The last step is to create a copy of the person we are favoriting or unfavoriting and simply change its favorite status via the aforementioned `boolean`. Since the `Person` class takes two constructors, the following constructor allows creating a copy of a given `ReadOnlyPerson`.
[usage,java]
----
