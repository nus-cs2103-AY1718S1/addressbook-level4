...
.  Performance requirements: Should be able to give a response within 1 second
.  Security requirements: Should be able to hide personal
   information using a password
.  Quality requirements: Should be simple enough for a novice to utilise and navigate
.  Privacy requirements: Data should only be read and modified by authorized party
.  Maintenance requirements: Should be easily maintained by other programmers
