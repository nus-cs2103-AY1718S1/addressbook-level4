...
Validity of the input string for phone is checked in the following method in the Phone class:
[source,java]
----
...
----
The regex ensures that the user must adheres to the
correct format of `p/student/(STUDENT_NUMBER) parent/(PARENT_NUMBER)`, and that the
phone numbers must be exactly 8 digits long.

The phone contact information of the student and his/her parent will be displayed below the student's name in the person card.
