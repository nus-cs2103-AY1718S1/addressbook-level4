...
2.  User requests to show the list of contacts
3.  AddressBook shows a list of people without the deleted contact
3.  User requests to undo
4.  AddressBook undo the deletion
5.  User request to show the list of contacts
6.  AddressBook shows a list of people with the previously deleted contact
+
Use case ends.
...
5.  User request to show the list of contacts
6.  AddressBook shows a list of people with the previously deleted contact
7.  User request to redo previous undone delete command
8.  User request to show the list of contacts
9.  AddressBook shows the list of person without the delete contact
+
Use case ends.
