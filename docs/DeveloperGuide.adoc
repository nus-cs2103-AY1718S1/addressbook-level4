...
The UI consists of a `MainWindow` that is made up of parts e.g.`CommandBox`, `ResultDisplay`, `PersonListPanel`, `StatusBarFooter`, `MapsPanel` etc. All these, including the `MainWindow`, inherit from the abstract `UiPart` class.
