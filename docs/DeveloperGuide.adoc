...
parse the command accordingly. A `SortCommand` will be returned to the `LogicManager` which will then execute it. The sequence diagram for this scenario is shown in Figure 2 below.
