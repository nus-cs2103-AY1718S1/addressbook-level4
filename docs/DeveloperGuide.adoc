...
----
_Figure 4.6.1: Code section in EmailCommand.java_


The outcome of successful launching of email platform to send email to multiple contacts r is shown in _Figure 4.9.3_:

image::EmailCommand.PNG[width="800"]

_Figure 4.9.3: Output of `EmailCommand.java` execution_
