...
|`* * *` |user |find a person by middle or last name |accurately locate details of persons without having to go through the entire list

|`* * *` |user |click buttons to work in the app |use the app more conveniently

|`* * *` |user |add custom fields |store special info about a person

|`* * *` |user |list contacts in alphabetical order |locate persons more easily

|`* * *` |user |edit fields |use the app more easily
...
|`* *` |user |have aesthetically pleasing UI |

|`* *` |user |find a person by a custom search criterion |help recognize a person without knowledge of name
...
|`* *` |user |see the details of a person in an organised manner |use the app more easily

|`* *` |user |list contacts according to custom groups |easily reach a certain group of contacts

|`*` |user |add/delete/find information in (O logN) time |fast information retrieval
...
2.  AddressBook shows an example of find person message
3.  User follows the format and provide the name of the person
