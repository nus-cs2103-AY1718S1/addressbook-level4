...
image::MeetingCLass.png[width="300"]
_Figure 5.4.1 Meeting Class_
...
_Figure 5.8.1 : Find Exact Meeting Sequence Diagram_
...
_Figure 5.12.1 : Sequence diagram of Ui of Meeting Card_
...
_Figure 5.12.3 : Meeting card that due within 24 hours_

* `red` : Meeting is in next 48 hours.

image::MeetingCard2.png[width="250"]
_Figure 5.12.4 : Meeting Card that due within 48 hours_

* `orangeRed` : Meeting is in next 72 hours.

image::MeetingCard3.png[width="250"]
_Figure 5.12.5 : Meeting Card that due within 72 hours_
...
_Figure 5.13.1 : Reminder for single meeting_
...
_Figure 5.13.2 : Reminder for group meeting_
