...
Figure 4.12.1 below shows how the result display is directly populated at launch. This allowed us to work around the limitations of result display, which usually only displays results upon user input.
