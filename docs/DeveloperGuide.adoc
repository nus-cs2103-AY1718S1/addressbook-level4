...
|`* *` |user |have Google Contacts integration| view and modify my contacts on other platforms than my computer
...
4.  AddressBook deletes the tag from every person in the address book
+
Use case ends.
...
4.  AddressBook requests for field to change
5.  User selects a field
6.  AddressBook requests for data to be entered
7.  User provides new details
8.  AddressBook confirms that user wishes to change data
9.  User confirms the change
10.  AddressBook changes the information in the field
+
Use case ends.
...
* 8a. User inputs something other than yes or no.
+
[none]
