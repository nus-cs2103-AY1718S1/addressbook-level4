...
as showing number of events per day to dynamic colour changes in the future. The `monthDateBuilder` provides an accurate
graphical representation of the days in a monthly calendar. +
