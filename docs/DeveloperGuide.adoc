...
By: `Team F09-B2`      Since: `Jun 2016`      Licence: `MIT`
...
Sort mechanism operates by sorting the `internalList` in `UniquePlaceList`. This command allows the user to sort the list in alphebatical orders.
...
image::DirectionSequenceDiagram.png[width="800"]
