...
When `firstTimeOpen` is detected as `true` by the `MainWindow`, `TutorialPanel` will be added into the tutorial place holder.
 `TutorialPanel` will be removed at the end of the tutorial. Figure 4.10.1 shows the sequence of events that happens.
