...
In view of the link:https://en.wikipedia.org/wiki/Open/closed_principle/[open / closed principle], the Command class is open to extension but closed to modification. Thus, to implement this feature, a new `BatchCommand` class is extended from the Command class. +
...
The seemingly roudabout sequence of function calls within the Model component was conceived in view of the link:https://en.wikipedia.org/wiki/Law_of_Demeter[Law of Demeter].
