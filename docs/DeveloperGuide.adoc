...
|`* * *` |user |get help information |know where is wrong whe I get errors

|`* * *` |user |update contact's information |correct or add their information

|`* * *` |user |list contacts |view who are my contacts

|`* * *` |user |hide private details  |minimise the chance of someone else seeing them by accident

|`* * *` |user |undo decision  |revert changes in case of mistake
...
|`* *` |careful user |log in with my id and password |keep my privacy

|`* *` |elder user |adjust font size |see more clearly

|`* *` |user |hide link:#private-contact-detail[private contact details] by default |minimize chance of someone else seeing them by accident

|`* *` |user |find a person by name |save time from browsing through the entire list

|`* *` |forgettable user |stick some important people on the top|locate them quickly
...
|`*` |user |alter whether information is private  |make information open to everyone whenever I want

|`*` |user |sort the list  |locate a person easily

|`*` |user |clean AddressBook  |save time from deleting people one by one

|`*` |user |drag person card |reorder the list easily
...
1. User enters "help" for the help command
