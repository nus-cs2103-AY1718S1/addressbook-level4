...
We keep the event or the person added by that command.

* To undo it, we delete it from the addressbook.
* To redo it, we re-add it to the addressbook.
...
1. Delete the person from addressbook. +
2. Remove 
