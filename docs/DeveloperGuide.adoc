...
_Figure 3.6.0.1 : GmapCommand object class diagram_
...
_Figure 3.6.1.1 : GmapCommand parser sequence diagram_
...
_Figure 3.6.1.2 : GmapCommand execution sequence diagram_
...
_Figure 3.6.2.1 : GmapCommand GUI sequence diagram_
...
_Figure 3.8.1.1 : Import CLI execution sequence diagram_
...
*Refer to UserGuide 3.9*

image::ImportSequenceDiagram2.png[width="750"]
_Figure 3.8.1.1 : Import Feature GUI sequence diagram_
