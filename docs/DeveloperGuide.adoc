...
The *_link:#architecture-diagram[Architecture Diagram]_* given above explains the high-level design of the App. Given below is a quick overview of each component.
...
_Figure 3.6.1 : White Theme_

image::greenThemeUI.png[width="800"]
_Figure 3.6.2 : Green Theme_
...
|`* * *` |user |find people by address and see them on a map |find people who live near me
...
|`* *` |user |have contacts of relevant supplier |contact whichever services i want at the point of time.
...
|`* *` |user |have an image associated to the contact details |know how my friends look like.
...
.  Should have IntelliJ IDE installed in computer.
