...
The sort command creates `CommandResult` object and return it.
...
The following *_sequence_* diagram _(Figure 3.6)_ below shows how the delete event operation works:
...
The following *_sequence_* diagram _(Figure 3.7)_ below show how the show participants operation works:
...
The following *_sequence_* diagram _(Figure 3.8)_ show how the show all joined events operation works:
...
[discrete]
==== Model level
For model, we simply use the "referencing model", which is shown in the diagram _(Figure 3.7.1)_ below: +

image::DG_model_join.png[width = "800"]
_Figure 3.7.1 interaction model_
...
[discrete]
==== Storage level
For storage, since persons and events reference each other, it is easy to have an *Infinity loop of reference*, as shown in the diagram _(Figure 3.7.2)_ below:

image::DG_infinity loop.png[width = "800"]
_Figure 3.7.2 infinity loop_
...
The updated storage is shown in the diagram _(Figure 3.7.3)_ below:

image::DG_join_storage.png[width = "800"]
_Figure 3.7.3 interaction storage_
...
2.  Planno shows a list of sorted person.s
+
Use case ends.
...
+
[none]
** 2a1. Planno shows a successful message.
+
Use case ends.
...
+
[none]
** 3a1. Planno shows an error message.
+
Use case resumes at step 2.
