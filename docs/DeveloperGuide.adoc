...
This feature enables several fields of the student to be optional.
...
Pros: Simpler to understand and tweak this feature as it only manipulates the parsed input. +
