...
The sort command is implemented to highlight the contacts with the specified tag
...
This change is reflected in the UI with the refreshing of the persons list and the instantiation of the highlight styling
in the generation of the PersonCard
