...
Please install them if they are disabled. +
Checking plug-ins by going to `File` > `Settings` > `Plugins`.
...
This *_Architecture Diagram_* given below explains the high-level design of the App.
