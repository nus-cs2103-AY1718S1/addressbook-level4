...
The ability for users to enter multiple different words for
==== Design Considerations
...
The `KeyListener` requires access to the `CommandBox` and `PersonListPanel` for key event executions,
