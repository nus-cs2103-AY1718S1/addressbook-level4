...
**Cons:** Fragile architecture, have to change a few functions every time an extra command is added. Slightly harder to display selection of command in the helper box to the user.
