...
[discrete]
=== Use case: Generate encoded parcel details
...
2.  AddressBook shows decoded details and prompts user on whether to save parcel
3.  User accepts save
4.  AddressBook saves decoded parcel's contact
+
Use case ends
...
....
An encoded string that contains the parcel details of a particular parcel
....
