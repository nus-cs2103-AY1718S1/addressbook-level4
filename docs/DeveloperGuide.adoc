...
:repoURL: https://github.com/C02-B2/addressbook-level4/tree/WK-7-V1.0
...
|`* * *` |user |delete multiple persons at once  |I do not have to go through the hassle of removing one at each time

|`* * *` |user |find a person by name |locate details of persons without having to go through the entire list

|`* * *` |user |select multiple person |I can perform the same command to multiple contacts at once
...
|`* *` |user |rename existing tag |I can update my relationship with contact
...
7. AddressBook shows a sucessful message regarding the replacement
Use case ends.
