...
[NOTE]
If sorting type is not found, an error message will to notfiy the user of an unknown sorting type.
...
The implementation of the comparator for *Company* and *Position* is as follows:
