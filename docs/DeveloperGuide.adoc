...
The attributes of Meeting class include `NameMeeting`, `DateTime`, `Place`, `Persons` and `MeetingTag`.
...
'Name' of Meeting, 'Date and Time' of Meeting, 'Location' of Meeting, and lastly, 'Importance' of Meeting.
...
The select meeting command inherits from Command which allows user to select a meeting with the following parameters:
'INDEX' of meeting in the last meeting listing.
...
**Pros:** Allows developer to make use of the already established maps. +
