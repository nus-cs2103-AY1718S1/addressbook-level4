= About ConTag's Developer Guide
:toc:
:toc-title:
...
Welcome to the ConTag's Developer Guide! Contag is an efficient and feature-packed address book desktop application custom-built for PC, capable of organizing contacts for even the most demanding business users and busiest frequent travellers.Regardlless if you are a beginner user or expert developer, this guide brings to you all the necessary information you will need to navigate around the  ConTag with ease.This guide provides a comprehensive covergae of the initial set up, implementation of the features, coding, documentation writing to the testing of the application.Let's start from zero knowledge to full knowledge!
