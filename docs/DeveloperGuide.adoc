...
In view of the open / closed principle, the Command class is open to extension but closed to modification. Thus, to implement this feature, a new `BatchCommand` class is extended from the Command class. +
