...
A newly added, or edited person will be automatically selected in the `PersonListPanel`. This makes it easier for the user to take note
of changes made to their contacts.

This implementation is done by raising an event whenever the add and edit command respectively is executed.
