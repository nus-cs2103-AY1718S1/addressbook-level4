= ResidentBook Level 4 - Developer Guide
:toc:
:toc-title:
...
After forking the repo, links in the documentation will still point to the `se-edu/residentbook-level4` repo. If you plan to develop this as a separate product (i.e. instead of contributing to the `se-edu/residentbook-level4`) , you should replace the URL in the variable `repoURL` in `DeveloperGuide.adoc` and `UserGuide.adoc` with the URL of your fork.
...
**Additional Info:** See our discussion  https://github.com/se-edu/residentbook-level4/issues/390#issuecomment-298936672[here].
...
** See this https://github.com/se-edu/residentbook-level4/pull/590/files[PR] for the full solution.
****
...
** See this https://github.com/se-edu/residentbook-level4/pull/591/files[PR] for the full solution.
****
...
* Solution
** See this https://github.com/se-edu/residentbook-level4/pull/592/files[PR] for the full solution.
****
...
** See this https://github.com/se-edu/residentbook-level4/pull/593/files[PR] for the full solution.
****
...
** See this https://github.com/se-edu/residentbook-level4/pull/596/files[PR] for the full solution.
****
...
* Solution
** See this https://github.com/se-edu/residentbook-level4/pull/594/files[PR] for the full solution.
****
...
See this https://github.com/se-edu/residentbook-level4/pull/599[PR] for the step-by-step solution.
