...
|`* *` |user |rename existing tag |update my relationship with contact
...
4.  AddressBook deletes the person
5.  AddressBook adds remark to contact
6.  AddressBook shows successful message regarding adding of remark
+
Use case ends.
...
4. AddressBook replace the name of the existing to the newer version
5. AddressBook prompt user to confirm the changes
6. AddressBook shows a sucessful message regarding the replacement
Use case ends.
...
5a. User disconfirm the changes
