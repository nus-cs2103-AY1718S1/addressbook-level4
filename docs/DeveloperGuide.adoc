...
_Figure 4.21 : Sequence Diagram of Optional Inputs/Fields Operation_
...
_Figure 4.22 : Messages shown when the user does not enter the optional fields_
...
_Figure 4.31 : Sequence Diagram of `Remark` Operation_
...
image::LogicCommandClassDiagram.png[width="800"]
_Figure 4.32 : Inheritance Diagram for Commands_
...
_Figure 4.41 : Sequence Diagram of `FindTags` Operation_
...
_Figure 4.51 : Stack Diagram of Initial Stack_

As the user continues to use the program, more commands are added into the `undoStack`. For example, the user may execute `add n/David ...` to add a new person.

image::UndoRedoNewCommand1StackDiagram.png[width="800"]
_Figure 4.52 : Stack Diagram of Commands Added_
...
_Figure 4.53 : Stack Diagram of Undo Execution_
...
_Figure 4.54 : Sequence Diagram of UndoRedo Feature_
...
_Figure 4.55 : Stack Diagram when a new Command, Clear is Executed_

Commands that are not undoable are not added into the `undoStack`. For example, `list`, which inherits from `Command` rather than `UndoableCommand`, will not be added after execution:

image::UndoRedoNewCommand3StackDiagram.png[width="800"]
_Figure 4.56 : Stack Diagram when Undoable Command is Executed_

The following activity diagram summarize what happens inside the `UndoRedoStack` when a user executes a new command:

image::UndoRedoActivityDiagram.png[width="200"]
_Figure 4.57 : Activity Diagram of UndoRedoStack_
...
_Figure 4.61 : Sequence Diagram of Sort Operation_
...
_Figure 4.71 : Sequence Diagram of Schedule Operation_
...
_Figure 4.91 : Sequence Diagram of `home` Operation_
...
_Figure 4.111 : Sequence Diagram of `Tab` Operation_
...
_Figure 4.121 : Activity Diagram of updating the`Statistics Panel` ._
...
_Figure 4.131 : Sequence Diagram of Unique Color Tag Operation_
...
_Figure 4.132 : Color Range of Hue, Saturation and Luminance_
...
_Figure 4.133 : Compatibility of tag color background with white font of tag description_
...
_Figure 5.12 : Valid Displayed Person Card Phone Information_
...
_Figure 5.13 : Message to prompt Users to Enter Correct Phone Format_
