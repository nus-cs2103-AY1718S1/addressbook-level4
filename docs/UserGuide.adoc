...
.   Type in (Figure 2.3.1) +
`>> list` +
image:list1.png[list1, 600] +
_Figure 2.3.1(`filter` was run)_
.   Press Enter. You should now see a list of all your contacts (Figure 2.3.2) +
...
. Typing (Figure 2.10.1) +
`>>select 1` +
image:select1.png[select1, 600] +
_Figure 2.10.1_
. Press Enter and your choice should now be selected (Figure 2.10.2) +
...
.   Type in your desired INDEX and NOTE (Figure 2.11.1) +
`>> note 1 n/This is an important note` +
image:note1.png[note1, 600] +
_Figure 2.11.1_
. Press Enter. Your note should now be displayed as the last row in your contact's details (Figure 2.11.2) +
...
_Figure 2.14.1_ +
.   Press Enter. Your default browser should open a login window (Figure 2.14.2) +
image:sync2.png[sync2, 600] +
_Figure 2.14.2_
.   Enter your login details and press Next (Figure 2.14.3) +
image:sync3.png[sync3, 600] +
_Figure 2.14.3_
.   Allow DummyName to access your Google Contacts information (Figure 2.14.4) +
image:sync4.png[sync4, 600] +
_Figure 2.14.4_
.   Your contacts are now synchronised. Figure (2.14.5)
...
_Figure 2.18.1_
.   Press Enter. Your contacts should now be cleared (Figure 2.18.2) +
