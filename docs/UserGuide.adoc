...
[NOTE]
====
Tag color is not fixed. (i.e. when tag color is offed and on again, the color is different)
====
...
=== Customizing Tag Colors : [In Progress]
****
* Allows the user to customize a tag's color
****
