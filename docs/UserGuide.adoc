...
_Figure 3. HitMeUp User Interface_
...
_Figure 5.11a. Google Authentication Page_
+
...
_Figure 5.11b. Google Consent Page_
+
...
_Figure 5.11c. HitMeUp Import Progress_
+
...
_Figure 5.11d. Import Result Display_
//end::import[]
...
_Figure 5.12. Data folder directory containing vCard file_
...
_Figure 5.13. Default mail application in Windows 10_
