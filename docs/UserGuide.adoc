...
To show the urgency of the meeting, colours are assigned to the card by comparing the date and time of the meeting class to the date and time of the log in.
...
Returns any meeting having names `Betsy`, `Tim`, or `John` as the person to meet
