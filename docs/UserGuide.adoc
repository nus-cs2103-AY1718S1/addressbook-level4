...
* `find Betsy` +
`select 1` +
By typing `find Betsy`, you will be able to find any person having the name `Betsy`. +
By typing `select 1`, you are selecting the 1st person in the results of the `find Betsy` command which will
displays the information details of the 1st person in the graphical user interface.

* `list` +
`select 3` +
Selects the 3rd person in The Myth's Book. +
...
* `list` +
`delete 2` +
This will delete the 2nd person in The Myth's Book.
* `find Betsy` +
`delete 1` +
This will delete the 1st person in the results of the `find` command.
...
2.`select 6` +
3.`access 6` +
Lists down all the contacts and selects the 6th person in The Myth's Book. +
By typing `access 6`, it allows you to access the website of the 6th person which is loaded into the browser.
...
image::sampleeventresult.PNG[width="200"]
...
* 1.`list` +
2.`locate 6` +
Lists down all the contacts and `locate 6` selects the 6th person in The Myth's Book. +
The address details of the 6th person is then used in a Google Maps Search.

By typing `locate 6`,
You should see the displayed result of the person's address in a Google Maps Search as seen in Figure 6.6.1 below.
...
Furthermore, you can add events after clicking on the specific date. A pop up window as shown below will appear prompting you to fill up the details of the event.
