...
* If find command is executed after executing view command, the find command would not support find module code if it is viewed into a specific module code and if it is viewed into a specific location, it will not support find location.
****
...
Returns a list of location +
`sort` +
Return a list of location sorted in alphabetical order for letters and increasing order for numbers.
...
`sort` +
Return a list sorted by code in alphabetical order for letters and increasing order for numbers.
