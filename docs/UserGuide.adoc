...
You can delete multiple contacts who contain a single specified tag. Or, you may specify multiple tags and MedNus will perform the same operation for all of these tags. +
