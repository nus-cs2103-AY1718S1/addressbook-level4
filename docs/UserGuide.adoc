...
The popup window will show for 7 seconds before closing itself. You can als close the window manually by clicking
the `x` at the top right of th window. Figure 4.4.1 below is an example of what the popup window looks like:
