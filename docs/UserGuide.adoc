...
// tag::changetheme[]
=== Change the theme according to user input `theme` _[Since v1.5]_
...
* When you only key in `theme`, the result box would display "1.Twilight 2.Sunburst 3.Minimalism", you can simply key in the index after that to change into your preferred theme.
