...
* `add n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01 pc/321123 d/123`
...
* `borrow 2 1000` +
Increases the debt of the 2nd person by $1000.
...
* *Add* `add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS pc/POSTAL CODE d/DEBT [t/TAG]...` +
e.g. `add n/James Ho p/22224444 e/jamesho@example.com a/123, Clementi Rd pc/123466 d/123 t/friend t/colleague`
* *Clear* : `clear`
* *Borrow* : `borrow INDEX AMOUNT` +
e.g. `borrow 1 500.50`
* *Delete* : `delete INDEX` +
e.g. `delete 3`
* *Edit* : `edit INDEX [n/NAME] [p/PHONE_NUMBER] [e/EMAIL] [a/ADDRESS] [pc/POSTAL CODE] [d/DEBT] [t/TAG]...` +
