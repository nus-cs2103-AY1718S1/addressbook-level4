...
* **`add`**`n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01 S123123` : adds a contact named `John Doe` to the Address Book.
...
* `add n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01 S123123`
* `add n/Betsy Crowe t/friend e/betsycrowe@example.com a/Newgate Prison S321345 p/1234567 t/criminal`
...
* `find Betsy Tim John` +
Returns any parcel having names `Betsy`, `Tim`, or `John`
...
****
* Selects the parcel and loads the Google search page the parcel at the specified `INDEX`.
* The index refers to the index number shown in the most recent listing.
* The index *must be a positive integer* `1, 2, 3, ...`
****
...
e.g. `add n/James Ho p/22224444 e/jamesho@example.com a/123, Clementi Rd, S123665 t/friend t/colleague`
* *Clear* : `clear`
* *Delete* : `delete INDEX` +
e.g. `delete 3`
