...
Format: just type in the search bar the name or the phone number you want to search for, and the results will be automatically displayed in the left panel. `since v1.2`
