...
image::aptexamplecancel.png[width="500"]
...
image::calendardexample.PNG[width="500"]
    Figure 12: Appointment Calendar Day View

Week View +

image::calendarwexample.PNG[width="500"]
    Figure 13: Appointment Calendar Week View

Month View +

image::calendarmexample.PNG[width="500"]
    Figure 14: Appointment Calendar Month View

Year View +

image::calendaryexample.PNG[width="500"]
