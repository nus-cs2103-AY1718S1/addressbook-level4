...
Adds a person into a list of favorite contacts. +
Format: `fav INDEX`

****
* Adds the person as a favorite contact at the specified `INDEX`.
...
Removes a person from the list of favorite contacts. +
Format: `unfav INDEX`

****
* Removes the person from the list of favorite contacts at the specified `INDEX`.
* The index refers to the index number shown in the most recent listing.
* The index *must be a positive integer* 1, 2, 3, ...
****
...
=== Listing all favorite persons: `listfav`

Shows a list of all favorite contacts in the address book. +
Format: `listfav`
