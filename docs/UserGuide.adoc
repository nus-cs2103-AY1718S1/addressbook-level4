...
[NOTE]
====
Pressing kbd:[&tab;] will attempt to autocomplete current command. Turns text red if not suitable command exists. Since v1.1
====

[NOTE]
====
Each person now can be assigned a group. The group is used to sort people into specific tours for the tourguide. Since v1.2
====

[NOTE]
====
Ability to filter the UI display to only display selected groups. Coming V2.0
====
...
Automatically completes the command you are typing +
Format: type the start of the command wanted --TODO
...
*Admin:* You can also export a backup of the data to any directory using --TODO
...
*Q*: Why do I need admin to access some of the features? +
