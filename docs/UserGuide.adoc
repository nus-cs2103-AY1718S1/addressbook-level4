...
****
* The search is case insensitive. e.g ` [e/google]` will match emails of google.com domain`
* Only full words will be matched e.g. `[e/goo]` will not match emails with google.com domain`
****
...
* `find e/yahoo` +
Returns person with email of yahoo domain`

=== Deleting persons by range : `delete`
...
* The indices indicated must be different from each other
****
