...
Format & Example: `help` +
You can see the following help window.
...
You will see the following after typing 3 above example command :
...
You can use it to edits an existing person in the event list. +
