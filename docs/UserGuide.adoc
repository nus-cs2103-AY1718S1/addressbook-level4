...
This user guide will give you an overview of how to properly use the Codii app.
This guide includes step by step instructions on how each commands work, FAQs and a summary on every command you will learn.

The terms used in this guide are as followed:
* Blacklist - List of people who are banned
* Index - The ordering of a contact on the list

== Introduction

Codii is a free to use address book catered to suit the needs of debt collectors. You can enter debtors into the Codii app,
track the amount of debt owed, manage deadlines, ban and unban debtors and even organise them by location.

Codii is available for the Linux, Unix, Windows XP, and Mac OS X operating systems.
...
Edits an existing debtor, black / white listed contact in the address book. +
