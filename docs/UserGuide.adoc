...
=== Connecting to Facebook: `connectfacebook`

Synchronizes your AddressBook with your personal Facebook account. +
Format: `connectfacebook`

****
* Launches a Facebook authorization page in the browser
****

=== Adding all Facebook Friends: `addallfacebookfriends`

Adds all your Facebook friends into your AddressBook. +
Format: `addallfacebookfriends`
...
=== Adding a Facebook contact: `addfacebookcontact`

Searches for a specific Facebook User to add to AddressBook. +
Format: `addfacebookcontact USER_NAME`
...
* `addfacebookcontact Barack Obama` +
