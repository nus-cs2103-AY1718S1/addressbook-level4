...
| *Help* | *h* | `[.underline]#help#` +
| *Add* | *a* | `[.underline]#add# n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS [t/TAG]...` +
| *List* | *l* | `[.underline]#list#` +
| *Edit* | *e* | `[.underline]#edit# INDEX [n/NAME] [p/PHONE_NUMBER] [e/EMAIL] [a/ADDRESS] [t/TAG]...` +
| *Favourite* | *fav* | `[.underline]#favourite# INDEX` +
| *Find* | *f* | `[.underline]#find# [PREFIX KEYWORD]...` +
| *Delete* | *d* | `[.underline]#delete# INDEX` +
| *Select* | *s* | `[.underline]#select# INDEX` +
| *History* | *hs* | `[.underline]#history#` +
| *Undo* | *u* | `[.underline]#undo#` +
| *Redo* | *r* | `[.underline]#redo#` +
| *Remove* | *rm* | `[.underline]#remove# [TAG]... [INDEX]...` +
| *Clear* | *c* | `[.underline]#clear#` +
| *exit* | *x* | `[.underline]#exit#` +
|=======================================================================

The underlined command keywords can be substituted by their aliases. +
For e.g. to favourite the person at INDEX 4: `fav 4` instead of `favourite 4` can be used.
