...
=== Adding a person/event : `add(E)`

Adds a person/event to the application. +
Format: `add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS [t/TAG]...`
Format: `addE n/NAME d/DATE_TIME a/EMAIL a/ADDRESS `

[TIP]
A person can have any number of tags (including 0).
Events added will be automatically sorted by date/time

Examples:

* `add n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01`
* `add n/Betsy Crowe t/friend e/betsycrowe@example.com a/Newgate Prison p/1234567 t/criminal`
* `addE n/Does Birthday d/25122015 20:30 a/Does crib `
* `addE n/Betsy Birthday d/25122016 21:30 a/Betsy crib `


=== Listing all persons/events : `list(E)`

Shows a list of all persons/events in the application. +
Format: `list`

=== Editing a person/event : `edit(E)`

Edits an existing person/event in the application. +
Format: `edit INDEX [n/NAME] [p/PHONE] [e/EMAIL] [a/ADDRESS] [t/TAG]...`
Format: `editE INDEX [n/NAME] [d/DATE_TIME] [a/ADDRESS]`
...
* `editE 1 n/Telegram Birthday` +
Edits the name of the 1st event to be `Telegram Birthday`.

* `editE 2 d/25102017 21:30` +
Edits the date of the 2nd event to be `25102017 21:30`.
...
=== Deleting a person/event : `delete(E)`
...
* `list` +
`delete(E) 2` +
Deletes the 2nd person/event in the address book.
* `find Betsy` +
`delete(E) 1` +
Deletes the 1st person/event in the results of the `find` command.
...
* The value of the parameter `COLOR` should be a valid RGB value (in hexadecimal, starting with a `#`). You can pick the
RGB value of your favorite color from https://www.w3schools.com/colors/colors_rgb.asp[here].
****
