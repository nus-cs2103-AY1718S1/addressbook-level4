...
[width="59%",cols="10%,<5%,<35%,<40%",options="header",]
|=======================================================================
...
|`Delete` |`d`|`delete INDEX [OTHER INDICES]`|
...
|`Schedule` |`sc` |`schedule d/DATE act/ACTIVITY` | `schedule 1 d/25-12 act/Christmas dinner`

|`Copy` |`cp` |`copy INDEX [OTHER INDICES]`
