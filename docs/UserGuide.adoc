...
* **`add`**`n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01` : adds a contact named `John Doe` to the Contact Pro.
...
Adds a person to the Contact Pro +
...
Shows a list of all persons in the Contact Pro, sorted alphabetically by full name. +
Format: `list` or `ls`
...
Edits an existing person in the Contact Pro. +
...
Deletes the specified person from the Contact Pro. +
...
* `list` +
`delete 2` +
Deletes the 2nd person in the Contact Pro.
* `find Betsy` +
`delete 1` +
Deletes the 1st person in the results of the `find` command.
* `list` +
`del 1` +
Deletes the 1st person in the Contact Pro.
...
* `list` +
`select 2` +
Selects the 2nd person in the Contact Pro.
* `find Betsy` +
`select 1` +
...
* `list` +
`group n/CS2103 2 3` +
Adds the 2nd and 3rd person to the group CS2103 in the Contact Pro.
* `find Betsy` +
`group n/Family 1` +
...
Removes the 2nd and 3rd person from the group CS2103 in the Contact Pro.
* `find Betsy` +
`ungroup n/Family 1` +
...
Clears all entries from the Contact Pro. +
Format: `clear` or `clr`
