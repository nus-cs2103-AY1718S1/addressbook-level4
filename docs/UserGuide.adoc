...
* *Add event* : `addE n/NAME d/DATE_TIME a/ADDRESS` +
e.g. `addE n/James birthday d/18022017 13:30 a/123, Clementi Rd, 1234665`
* *Clear* : `clear`
* *Delete* : `delete INDEX` +
e.g. `delete 3`
...
* *Edit event* : `edit INDEX [n/NAME] [d/DATE_TIME] [a/ADDRESS]` +
