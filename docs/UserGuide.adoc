...
Format: `addE n/NAME dt/DATE_TIME a/EMAIL a/ADDRESS `
...
* `addE n/Does Birthday dt/25122015 20:30 a/Does crib `
* `addE n/Betsy Birthday dt/25122016 21:30 a/Betsy crib `
...
Format: `editE INDEX [n/NAME] [dt/DATE_TIME] [a/ADDRESS]`
...
=== Exporting address book data : `export`

Exports the current data in the address book, including data from all three components: *Contacts*, *Events* and
...
* If a relative path is provided, the data will be exported to the *BoNUS* installation directory.
...
`export /Users/John Doe/Documents/addressbook.xml`
...
* *Add event* : `addE n/NAME dt/DATE_TIME a/ADDRESS` +
e.g. `addE n/James birthday dt/18022017 13:30 a/123, Clementi Rd, 1234665`
* *Clear* : `clear`
* *Delete* : `delete INDEX` +
e.g. `delete 3`
* *Delete event* : `deleteE INDEX` +
e.g. `deleteE 3`
* *Edit* : `edit INDEX [n/NAME] [p/PHONE_NUMBER] [e/EMAIL] [a/ADDRESS] [t/TAG]...` +
e.g. `edit 2 n/James Lee e/jameslee@example.com`
* *Edit event* : `edit INDEX [n/NAME] [dt/DATE_TIME] [a/ADDRESS]` +
...
eg. For `Windows` users: `export C:\Users\John Doe\Documents\addressbook.xml` +
eg. For `macOS` and `Linux` users: `export /Users/John Doe/Documents/addressbook.xml`
