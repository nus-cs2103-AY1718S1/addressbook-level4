...
=== Locating persons by names or phone numbers or tags: `finds` (NEW)
...
==== List important contacts from `[important] tag`

Person with [important] tag will always appear at the top of the list
