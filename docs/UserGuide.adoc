...
* `add #/RR000000000SG n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01 S123121 d/01-01-2001 s/pending`
* `add #/RR000000000SG n/Betsy Crowe t/friend d/02-02-2002 s/pending e/betsycrowe@example.com a/22 Crowe road S123123 p/1234567
 t/fragile`
...
[TIP]
The parcel list section can also be expanded or reduced by clicking and dragging the divider between the
parcel list section and browser section.
...
and expands the browser section in th main window. The browser section will then show a google map search
of the selected parcel's delivery address. +
Format: `select INDEX`
