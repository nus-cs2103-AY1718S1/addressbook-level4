...
[TIP]
Contacts will be sorted by their names (increment).them
=======
// end::sortByName[]
>>>>>>> master
...
As shown in Figure 5.14.1 and Figure 5.14.2, Figures depict the Bright Theme and Dark Theme respectively.

image::BrightTheme.png[width="300" height="200"]
_Figure 5.14.1 : Bright Theme_



image::DarkTheme.png[width="300" height ="200"]
_Figure 5.14.2 : Dark Theme_
