...
With many contacts and tasks to manage, differentiating birthdays and deadlines on the calendar can be done with the help of colours.
...
* A task has a deadline on `17-07-2017`. +
The corresponding date on the calendar is marked *red*. +
* A contact has his/her birthday on `09-12-2017`. +
The corresponding date on the calendar is marked *pink*. +
* `17-07-2017` that is both a task's deadline and a contact's birthday. +
