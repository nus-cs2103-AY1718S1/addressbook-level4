...
=== Listing entered commands : `(i)history`
...
=== Exporting address book data : `(p)export`
...
Format: `(cfg)config --add-property s/b f/birthday [m/Birthday should be in the format of DD/MM/YYYY r/[^\s].*]`
