...
Want to find a task? The find feature allows you to find task(s) using descriptions or deadline.

To find task(s) whose description contain any of the given keywords, use +
...
When you want to go back to the default list of tasks after a search, you can use the list command to return to the default list of tasks.
...
When you want to select a task, you can use the select command to select the task identified by the index number used in the last task listing.
