...
Highlights all persons with specified tag
Format: `highlight `tag``

[TIP]
Specifying a tag which does not exist on any person clears the current highlighted persons

Examples:
* `highlight colleague`
* `highlight owes money`
* `highlight nonExistentTag` - Clears current highlighting
