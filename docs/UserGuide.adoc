...
You can delete all persons in the address book who have a given tag. +
...
Examples: +
* `batch friends`
Removes all persons with the friends tag from the address book +
* `b family`
Removes all persons with the family tag from the address book +
