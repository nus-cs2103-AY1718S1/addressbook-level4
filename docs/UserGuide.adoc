...
=== Current Version
The current version of this application is *Version 1.3*.
...
* There are 2 types of searches. One based on the input and prefix and the other only on Keywords.
