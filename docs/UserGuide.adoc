...
Format: `add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS b/Birthday(DD/MM/YYYY) [w/WEBSITE] [t/TAG]...`
Shorthand: `a n/NAME [p/PHONE_NUMBER [e/EMAIL] [a/ADDRESS] [b/BIRTHDAY(DD/MM/YYYY)]  [w/WEBSITE] [t/TAG]...`
...
Format: `edit INDEX [n/NAME] [p/PHONE] [e/EMAIL] [a/ADDRESS] [b/Birthday(DD/MM/YYYY)] [w/WEBSITE] [t/TAG]...`
Shorthand: `e INDEX [n/NAME] [p/PHONE] [e/EMAIL] [a/ADDRESS] [b/Birthday(DD/MM/YYYY)] [w/WEBSITE] [t/TAG]...`
...
* *Add* `add n/NAME [p/PHONE_NUMBER] [e/EMAIL] [a/ADDRESS] [b/BIRTHDAY(DD/MM/YYYY)] [w/WEBSITE] [t/TAG]...` +
e.g. `add n/James Ho p/22224444 e/jamesho@example.com a/123, Clementi Rd, 1234665 w/https://www.yahoo.com/ t/friend t/colleague`
* *Clear* : `clear`
* *Delete* : `delete INDEX` +
e.g. `delete 3`
* *Edit* : `edit INDEX [n/NAME] [p/PHONE_NUMBER] [e/EMAIL] [a/ADDRESS] [b/BIRTHDAY(DD/MM/YYYY)] [w/WEBSITE] [t/TAG]...` +
