...
// tag::selectE[]
=== Showing all events which a person joins : `selectE`

You can use it to view all events which a certain person joins. +
Format: `selectE PERSON_INDEX`

****
* Shows all events which the person at the specified `PERSON_INDEXS` joins.
...
_Figure 3.13.1 default portrait_
...
* *Showing every event a person has joined* : `selectE p/INDEX` +
e.g. `selectE p/1`
