...
=== Addressbook Groups:
The address book stores all user created groups and allows the user to add people into existing groups. Coming v1.3

=== Group Filter: `filter`
Ability to filter the UI display to only display selected groups. Coming v1.4
