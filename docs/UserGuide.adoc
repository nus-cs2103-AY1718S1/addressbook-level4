...
[INFO]
This feature allows the adding of more than 1 EMAIL for a person since v1.3.

[INFO]
This feature restricts the ADDRESS to the format: `BLOCK, STREET, [UNIT,] POSTAL CODE` since v1.3.
...
[INFO]
This feature allows the deleting of more than 1 person since v1.1.
