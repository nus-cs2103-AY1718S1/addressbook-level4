...
* `add n/John Doe p/98765432 e/johnd@example.com se/john@u.nus.edu a/John street, block 123, #01-01 b/12/11/1972`
* `add n/Betsy Crowe t/friend e/betsycrowe@example.com se/betsy@u.nus.edu a/Newgate Prison p/1234567 b/02/03/2000 t/criminal`
