...
[NOTE]
Your inputs for NAME, ADDRESS and TAG will have the +
...
|Add an appointment to the contact |`appointment INDEX d/TIME to TIME` |`appointment 1 d/tomorrow 5pm`

|Shorthand for adding appointment  |`appt INDEX d/TIME to TIME` |`appt 1 d/tomorrow 5pm`

|Remove an appointment from the contact |`appointment INDEX d/off`| `appointment 1 d/off`

|Shorthand for removing appointment |`appt INDEX d/off`| `appt 1 d/off`

|Sort list by appointment dates |`appointment` |`appointment`
