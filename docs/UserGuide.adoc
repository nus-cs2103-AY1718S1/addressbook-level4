...
_Figure 4.11.1_
. Pressing Enter. Your choice should now be selected (Figure 4.11.2) +
...
_Figure 4.15.3_
.   Allow DummyName to access your Google Contacts information (Figure 4.15.4) +
...
. Press `Enter` and you should see that the effects of `delete 1` has been reverted. (Figure 4.17.3) +
...
_Figure 4.17.9_ +
. Press `Enter` and you should see that the `clear` command is reverted. (Figure 4.17.10)+
...
_Figure 4.18.4_ +
. Press `Enter` and you shoud see that the `undo` command has been reverted and the contact remains deleted. Refer to _Fig_ to see that you have obtained the correct results. (Figure 4.18.5) +
