...
image::multiDeleteCommand.png[width="790"]
...
image::tAddCommand.png[width="790"]
...
image::tRemoveCommand-noIndex.png[width="790"]
...
image::tRemoveCommand.png[width="790"]
...
image::tFindCommand.png[width="790"]
...
image::multiRestoreCommand.png[width="790"]
