...
* Have optional fields like (email, address, postal code and tags) when adding a student
* See student's academic progress over time from the `GraphPanel`
...
* Add schedules into the cherBook
