...
* Words in `UPPER_CASE` are the parameters to be supplied by the user e.g. in `add #/PARCEL_ID`,
 `PARCEL_ID` is a parameter which can be used as `add #/RR000000000SG`.
* Items in square brackets are optional e.g `#/PARCEL_ID [t/TAG]` can be used as `#/RR000000000SG t/fragile` or as
 `#/RR000000000SG`.
