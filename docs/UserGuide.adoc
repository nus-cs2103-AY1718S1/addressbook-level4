...
* If there is no music currently playing and you try to stop the music player, you may encounter "No music is currently playing" in the result box instead at your image:step2.png[width="70"]. No worries! It is not a problem at all! Just issue the `music stop`
...
* If the radio player is currently not playing and you try to stop the radio player, you may encounter "No Radio is currently playing" in the result box instead at your image:step2.png[width="70"]. No worries! It is not a problem at all! Just issue the `radio stop`
