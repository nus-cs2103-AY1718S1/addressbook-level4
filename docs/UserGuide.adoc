...
image::listexample.png[width="500"]
    Figure 4: List Command Usage Diagram
...
image::redoexample.png[width="700"]
    Figure 12: Redo Command Usage Diagram
...
image::aptexample.png[width="500"]
    Figure 13: Appointment Command Usage Diagram
...
image::remarkexample.png[width="500"]
    Figure 14: Remark Command Usage Diagram
...
image::exitUI.png[width="500"]
    Figure 15: Methods to access `exit` command
