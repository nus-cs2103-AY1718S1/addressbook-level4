...
* `add n/Betsy Crowe t/friend e/betsycrowe@example.com a/Newgate Prison p/1234567 b/AB d/2018/01/01 00:00 t/criminal`
...
Click link:#MedNusFeatures[here] for a tabulated version of all available listing options. +
...
*Format:* `list tag TAG1 TAG2...` +
 +
*Example:* `list tag colleagues friends` +
...
Example: `apt 1 d/next monday 3pm` +
Example: `apt 1 d/Sun, Nov 21, 2pm` +
