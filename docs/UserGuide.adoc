...
****
* Want to set a different keyword for parent mode? Check out the alias command below!
****
//end::parentmode[]
...
Pinned the wrong contact or you want to unpin that contact? Use the `unpin` command! +
Format: `unpin` `INDEX`
