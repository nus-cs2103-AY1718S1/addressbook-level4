= Gentleman's Guide (V1.5rc) - User Guide
:toc:
:toc-title:
...
*As a Gentleman, you respect those around you. As a Gentleman, you remember the day of their conception.
Thus you add their birthdays into the Gentleman's Guide.*
...
*You received an email from an unknown source. As a Gentleman, you do not ask who it is.
Thus, you look for the email in the Gentleman's Guide.*
...
*As a Gentleman, you want to know when your next date with The Lady is.
Thus, you search for "date" on the Gentleman's Guide.*
...
_Figure 3.16.1 : Unsorted reminder list ._

**After**

image::sortedlist.png[width="300"]
_Figure 3.16.2 : Sorted reminder list (In alphabetical order) ._
