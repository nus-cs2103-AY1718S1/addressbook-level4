...
Format: `add n/NAME [p/PHONE_NUMBER] [e/EMAIL] [a/ADDRESS] [d/DATE OF BIRTH] [t/TAG]...`
...
* *Add* `add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS d/DATE OF BIRTH [t/TAG]...` +
e.g. `add n/James Ho p/22224444 e/jamesho@example.com a/123, Clementi Rd, 1234665 d/27 01 1997 t/friend t/colleague`
* *Clear* : `clear`
* *Delete* : `delete INDEX` +
e.g. `delete 3`
