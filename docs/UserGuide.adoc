...
[NOTE]
Sort command is NOT undoable nor redoable, since the order is not preserved, and will revert to original order on execution of many other commands.
...
[NOTE]
Change theme feature available since v1.4.
