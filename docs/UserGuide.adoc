...
This is a quick introduction to cherBook's User Interface elements.
//TODO: Add user interface screenshot with highlights and labels
Insert screenshot here

_Figure 4.1 : cherBook's User Interface layout_

Here is a breakdown of the different elements of cherBook's user interface and how you can interact with them.
