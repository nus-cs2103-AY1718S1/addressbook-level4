...
Command Name: `delete` +
Shorthand Alias: `d` +
Function: Deletes the specified person at the specified `INDEX` from the address book. +
Format: `delete INDEX` +
====
...
_Figure 2.5.1_
.  Press `Enter` and you should see that the first contact that you selected has been modified. (Figure 2.5.2) +
