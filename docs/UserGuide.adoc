...
* The [green]`INDEX` refers to the index number of the person to be stalked in the contacts list.
...
* Contacts that match *any* of the provided [green]`KEYWORDS` will be displayed in the contacts list.
