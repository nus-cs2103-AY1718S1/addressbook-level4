...
=== Marking a person as 'Favourite': `AddFave`

Marks the person identified by the index number used in the last person listing as a favourite. +
Format: `addFave INDEX` +
Alias: `af`

****
* Marks the contact  at the specified `INDEX` as 'Favourite'.
* The index refers to the index number shown in the most recent listing.
* The index *must be a positive integer* 1, 2, 3, ...
****
...
* `addFave 1`
Marks the 1st contact as 'Favourite' in the address book.
* `af 1`

=== Unmarking a person as 'Favourite': `removeFave`

Unmarks the 'Favourite' status of the person at the specified `INDEX` +
Format: `removeFave INDEX` +
Alias: `rf`

****
* Unmarks the contact at the specified `INDEX` as 'Favourite'.
* The index refers to the index number shown in the most recent listing.
* The index *must be a positive integer* 1, 2, 3, ...
****
...
* `removeFave 1`
Unmarks the 1st contact as 'Favourite' in the address book.
* `af 1`

=== Creating a group: `gcreate`
...
e.g. `find James Jake`
* *Mark Favourite Contact* : `addFave INDEX` +
e.g. `addFave 1`
* *Unmark Favourite Contact* : `removeFave INDEX` +
e.g. `removeFave 2`
