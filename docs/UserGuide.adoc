...
Shorthand Format: `a n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS [t/TAG]...`
...
Shorthand Format: `e INDEX [n/NAME] [p/PHONE] [e/EMAIL] [a/ADDRESS] [t/TAG]...`
...
=== Toggle Tag Color Mode : `tagcolor`

Changes tag color mode to on/off. +
Format: `tagcolor On / tagcolor Off`

[NOTE]
====
To see changes, scroll the contact list up and down.
====
...
* *Add Shorthand Form* `a n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS [t/TAG]...` +
...
* *Edit Shorthand Form* : `e INDEX [n/NAME] [p/PHONE_NUMBER] [e/EMAIL] [a/ADDRESS] [t/TAG]...` +
