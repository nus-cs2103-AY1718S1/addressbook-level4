...
_Figure 4.1.16.1 : Remark List indicating remark for David Li_
...
Suggestion for use: You want to remind yourself that a particular contact likes to swim.

*Suggestion for use:* If you want to add/remove a remark pertaining to a person to take note of a task you want to do with him/her (e.g. You want to remind yourself that a particular person likes to swim).
...
_Figure 4.1.17.1 : Browser displaying Twitter profile of contact with a link_
