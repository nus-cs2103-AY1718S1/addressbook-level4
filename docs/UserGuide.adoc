...
. The different sections of the UI are as follows:
 ...
 a. Command Box - This is where you type your commands
 b. Result Display - The outcome of your commands will display here
 c. Sort menu - You can use this menu to sort the list
 d. Search Box - You can search for your contacts and tasks here
 e. Person and task list - Your list of contacts and tasks will be shown here
 f. Browser Panel - This is where the browser will appear
