...
****
*  Select a person in the list, the textboxes fill up with the individual's particulars.
...
5. Select `Tags` field and type new tags in this format: `tag1`,`tag2`,`tag3`...
