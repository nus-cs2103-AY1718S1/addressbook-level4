...
Focused on increasing ease of use for addressbook

[NOTE]
====
Pressing kbd:[&tab;] will attempt to autocomplete current command. Turns text red if not suitable command exists.
====
