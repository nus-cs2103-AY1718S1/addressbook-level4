...
=== Listing all persons removed: `bin-list` _[Coming in v2.0]

Shows a list of persons removed from the address book. +
Format: `bin-list`

=== Restoring person(s) : `bin-restore` _[Coming in v2.0]
...
=== Clearing all contacts from bin : `bin-clear` _[Coming in v2.0]
