...
. As Shown to you in the example above, the information regarding the next upcoming meeting is displayed in the message
...
+
image::Reminder(1).png[align="center"][width="600"]
+
...
Format: `findexactmeeting PHRASE`

****
* The search is case insensitive. e.g `john tan` will match `John Tan`
