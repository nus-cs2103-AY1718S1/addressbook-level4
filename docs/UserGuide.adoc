...
image::CommentCommand/addComment.PNG[width="800"]

'''
The result of `comment 3 c/Likes to play computer games.` shows the following:

image::CommentCommand/addCommentResult.PNG[width="800"]

'''
Removing comment from 4th contact.

image::CommentCommand/removeComment.PNG[width="800"]

'''
The result of `comment 4 c/` shows the following:

image::CommentCommand/removeCommentResult.PNG[width="800"]
...
'''
Adding appointment at `October 20th, 2017 14:45` to 2nd contact.

image::AppointCommand/addAppoint.PNG[width="800"]

'''
The result of `ppoint 2 ap/20/10/2017 14:45` shows the following:

image::AppointCommand/addAppointResult.PNG[width="800"]

'''
Removing the appointment from 4th contact.

image::AppointCommand/removeAppoint.PNG[width="800"]

'''
The result of `appoint 4 ap/` shows the following:

image::AppointCommand/removeAppointResult.PNG[width="800"]
// end::appointment[]
