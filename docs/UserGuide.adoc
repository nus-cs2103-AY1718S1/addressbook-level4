...
* `changePicture 1 D:/myPicture.png +
Change the profile picture of the first contact shown in the most recent listing to the picture specified at D:/myPicture.png
// end::changePicture[]
