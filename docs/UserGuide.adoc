...
Format: `add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS [f/] [t/TAG]... [s/SOCIAL_TYPE USERNAME]...`
...
* More information about the social platforms supported can be found in the <<social-media-integrations, Social Media Integrations>> section.
****
...
* `add n/Ah Beng p/123456 a/Yishun Drive e/ah@beng.com m/facebook ahbeng

==== Adding multiple phone number fields for contacts [Since v1.2]

Adds a contact with multiple phone number fields. +
Format: `add n/NAME p/PHONE p/87654321 e/EMAIL a/ADDRESS`

****
* Adds two phone number fields for the person.
* If there are valid phone numbers as well as invalid phone numbers entered, the valid phone numbers will be added and the invalid phone numbers will not be added to the contact.
****

Examples:

* `add n/John Doe p/98765432 p/87654321 e/johnd@example.com a/John street, block 123, #01-01`
...
Format: `edit INDEX [n/NAME] [p/PHONE] [e/EMAIL] [a/ADDRESS] [f/ OR uf/] [t/TAG]... [s/SOCIAL_TYPE USERNAME]`
...
* `edit 1 s/instagram ahbeng`
Edits the social media information of the first person to be an Instagram account with the username `ahbeng`.
...
==== To delete multiple persons [Since v1.1]:
...
=== Adding display photo for a person [Coming in v2.0]: `addphoto`
...
=== Representing social media accounts using the command line
...
* `facebook ah.beng10` represents the Facebook account with the username `ah.beng10`.
* `ig ahlian123` represents the Instagram account with the username `ahlian123`.

=== Facebook Integration [Since v1.2]:
...
==== Adding all Facebook Friends [Coming in v2.0]: `facebook addallfriends`
...
==== Adding a Facebook contact [Coming in v2.0]: `facebook addcontact`
