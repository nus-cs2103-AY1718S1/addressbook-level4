...
`Coming in v2.0` +
Synonyms/Aliases for the command: `set`, `connect` +
Sets the relationship between 2 persons
Format: `set [INDEX] [INDEX] [RELATIONSHIP]`

Examples:

*`list` +
* `set 1 2 siblings` +
Sets the relationship between John and Betsy to siblings.
