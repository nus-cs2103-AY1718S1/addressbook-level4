...
* `add n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01 w/https://github.com/JohnDoe`
* `add n/Betsy Crowe t/friend e/betsycrowe@example.com a/Newgate Prison p/1234567 w/https://github.com/BetsyCrowe t/criminal`
...
e.g. `add n/James Ho p/22224444 e/jamesho@example.com a/123, Clementi Rd, 1234665 w/https://github.com/JamesHo t/friend t/colleague`
* *Clear* : `clear`
* *Delete* : `delete INDEX` +
e.g. `delete 3`
* *Edit* : `edit INDEX [n/NAME] [p/PHONE_NUMBER] [e/EMAIL] [a/ADDRESS] [w/WEBSITE] [t/TAG]...` +
