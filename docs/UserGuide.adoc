...
Change the theme of the Rubrika to the theme specified.
...
* `select ` does not autocomplete because there is no prefix present, and no person data should be involved
...
* `delete ` does not autocomplete because the command does not involve person data
