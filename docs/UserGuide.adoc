...
You can delete a group of patients who share a single tag that you specify. Or, you may specify multiple tags and MedNus will perform this same batch deletion operation for each of these tags. +
