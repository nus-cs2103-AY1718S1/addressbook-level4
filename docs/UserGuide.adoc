...
=== Adding a note: `note` or `n` _(Coming in V2.0)_
...
* The index refers to the index number shown in the most recent listing.
* The index *must be a positive integer* `1, 2, 3, ...`
* An existing note will be replaced.
****

Examples:

* `note 1 r/Likes fishing` +
Sets the note of the 1st person to `Likes fishing`.
* `n 1 r/` +
...
| kbd:[Ctrl + Shift + D] | Clear contact list
...
| kbd:[Esc] | Deselect the command box
