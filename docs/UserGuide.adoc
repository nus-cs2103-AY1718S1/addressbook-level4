...
Format: `add n/NAME p/PHONE_NUMBER e/EMAIL se/SCHOOL_EMAIL a/ADDRESS b/BIRTHDAY [t/TAG]...`
...
Format: `edit INDEX [n/NAME] [p/PHONE] [e/EMAIL] [se/SCHOOL_EMAIL] [a/ADDRESS] [t/TAG]...`
