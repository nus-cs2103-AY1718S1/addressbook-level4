...
****
* Edits the person at the specified `INDEX`. The index refers to the index number shown in the last person listing. The index *must be a positive integer* (e.g. (e.g. 1, 2, 3, ...))
...
****
* Increases the debt and total debt of the debtor at the specified `INDEX` by `AMOUNT`. The index refers to the index number shown in the last person listing. The index *must be a positive integer* (e.g. (e.g. 1, 2, 3, ...))
...
****
* Decreases the debt of the person at the specified `INDEX` by `AMOUNT`. The index refers to the index number shown in the last person listing. The index *must be a positive integer* (e.g. (e.g. 1, 2, 3, ...))
* If no index is specified, the debt of the currently selected person is updated instead.
...
****
* Deletes the person at the specified `INDEX`. The index refers to the index number shown in the most recent listing. The index *must be a positive integer* (e.g. (e.g. 1, 2, 3, ...))
...
* The index *must be a positive integer* (e.g. (e.g. 1, 2, 3, ...))
