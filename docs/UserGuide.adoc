...
==== Selecting of date : `find`

[**TODO**]
To find any event (either birthday or deadline) happening on the date, use +
Format: `find d/DD-MM-YYYY`

Examples:

* `find 29-10-2017` +
Returns any person having birthday and/or any task having deadlines on `29-10-2017`

__Constraints:__

****
* Only the birthday and deadline are searched.
* Only valid date will be matched e.g `291017` will not match `29-10-2017`.
****
