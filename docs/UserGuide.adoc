...
+
.  You can download the latest `MedNus.jar` link:{repoURL}/releases[here].
...
image::dupsexample.png[width="800"]
    Figure 5: Duplicates Command Usage Example
...
You can add, sort and remove appointments from a specific contact at a given index. +
...
image::aptexample.png[width="800"]
    Figure 11: Appointment Command Usage Diagram for Adding

Canceling appointments +

image::aptexamplecancel.png[width="800"]
    Figure 11: Appointment Command Usage Diagram for Cancelling
...
image::calendardexample.PNG[width="800"]
    Figure 12: Appointment Calendar Day View

Week View +

image::calendarwexample.PNG[width="800"]
    Figure 13: Appointment Calendar Week View

Month View +

image::calendarmexample.PNG[width="800"]
    Figure 14: Appointment Calendar Month View

Year View +

image::calendaryexample.PNG[width="800"]
    Figure 15: Appointment Calendar Year View
...
You can delete a group of patients who share a single tag that you specify. Or, you may specify multiple tags and MedNus will perform the deletion operation for each of these tags. +
...
image::batchexample.png[width="800"]
    Figure 5: Batch Command Usage Example

[NOTE]
You can give MedNus multiple tags for batch deletion to be performed on.
// end::batch[]
...
image::copyexample.png[width="800"]
    Figure 5: Copy Command Usage Example
