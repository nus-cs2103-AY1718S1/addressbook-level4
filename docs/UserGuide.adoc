...
You should be able to see the result of using `themeslist` as seen in Figure 5.13.1.

image::themeslist.png[width="800"]
Figure 5.13.1 `themeslist` Result for Themes List Command
// end::themeslist[]
...
You should see the result of using `switch 2` as seen in Figure 5.14.1.

image::Switch.png[width="800"]
Figure 5.14.1 `switch 2` Result for Switch Command
// end::switch[]
