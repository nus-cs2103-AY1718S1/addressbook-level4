...
[[edit]]
=== `edit`, `change`, `modify` or `e`: Editing a Person _(Since v1.3)_
...
Format: `history` +
Alternatives: `history` can be replaced by `his` or `past` +
...
=== `remark`, `note` or `rmk`: Adding a Remark _(Coming in V2.0)_
