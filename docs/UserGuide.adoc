...
It might be daunting for a new user to see all these commands and their formats. But with the help of the drop-down list, you do not need to memorise any of them.
...
* continue to type in the rest of the command input in the required format, or
* press kbd:[Tab] to activate auto-completion, see link:#autocomplete[3.2. Auto-completion] for details.

If you want to see a list of all commands, simply type kbd:[Space] in an empty command box.
