...
* `a n/Jane Doe p/97979791 e/janed@example.com a/Jane street, block 456, #01-01 f/6C g/98`
...
// tag::tab[]
=== Switching Between LineChart and BarGraph : `tab` `Since v1.3`
//TODO: jonathan to explain how the tab command works
...
// tag::graphpanel[]
=== Graph Panel
//TODO: Jonathan can add explanations for how this brhaves and works
