...
image::Ark_Main_Window_Sections.png[width="890"] //CHANGE
...
image::Browser_Display_After_Selection.png[width="890"] //CHANGE
...
image::ParcelCard.png[width="890"] //CHANGE
