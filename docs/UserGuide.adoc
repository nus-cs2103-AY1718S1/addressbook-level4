...
You should see the result of using `themeslist` as seen in Figure 5.5.1.

image::themeslist.png[width="800"]
Figure 5.5.1 `themeslist` Result for Themes List Command
// end::themeslist[]
...
Figure 5.6.1 `switch 2` Result for Switch Command
// end::switch[]
...
You should see the displayed result of `select 3` as seen in Figure 6.6.1 below.

image::SelectCommandFinalResult.PNG[width="790"]
Figure 6.6.1 `Select 3` Displayed Result
...
You should see the displayed result of `access 6` as seen in Figure 6.10.1 below.

image::AccessCommandFinalResult.PNG[width="790"]
Figure 6.10.1 `Access 6` Result for Access Command
// end::access[]
...
4. You should see the displayed result of the person's address in a Google Maps Search as seen in Figure 6.11.1 below.

image::LocationCommandFinalResult.PNG[width="790"]
Figure 6.11.1 Location Command Result
// end::locate[]
...
You should see the result of using `events` as seen in Figure 7.1.1.

image::events.png[width="800"]
Figure 7.1.1 `events` Result for Events Command
// end::events[]
...
Furthermore, you can add events after clicking on the specific date. A pop up window (Figure 8.2.2) will appear prompting you to fill up the details of the event.
