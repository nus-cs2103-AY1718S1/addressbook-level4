...
[NOTE]
====
Most command can be interchangeable with the relevant substitute command listed below.
====
...
`COMPANY, POSITION, PRIORITY Coming in v2.0` +
Adds a person to the address book +
Format: `add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS [c/COMPANY] [po/POSITION] [pr/PRIORITY] [t/TAG]...`
...
* `add n/Betsy Crowe t/friend e/betsycrowe@example.com a/Newgate Prison c/ABC Foods po/Manager pr/L p/1234567 t/criminal`
...
Format: `edit INDEX [n/NAME] [p/PHONE] [e/EMAIL] [a/ADDRESS] [c/COMPANY] [po/POSITION] [t/TAG]...`
...
`Coming in v2.0` +
Sorts list by name or priority. +
Format: `sort [NAME_OR_PRIORITY]`
...
* *Add* `add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS [c/COMPANY] [po/POSITION] [pr/PRIORITY] [t/TAG]...` +
