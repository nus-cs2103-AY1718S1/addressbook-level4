...
* Matches a contact with the entered keyword from the beginning of the word.eg: 'Puj'
matches the name 'Pujitha' but 'uji' will not match the aforementioned name .
