...
*Format:* `add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS b/BLOODTYPE d/APPOINTMENTDATE [t/TAG]...` +
*Shorthand Format:* `a n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS b/BLOODTYPE d/APPOINTMENTDATE [t/TAG]...`
