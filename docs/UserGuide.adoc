...
Phone number, email and address are optional during the addition of a person
The Order in which name, phone number, email, address and tag are specified is non-specific
