...
+
image::UI(ScheduBook).png[width="790"]
+
...
* `addmeeting 1 n/John Doe d/31-10-2017 21:00 l/School of Computing, NUS`
* `addmeeting 2 n/Betsy Crowe d/27-12-2017 08:30 l/iCube Auditorium, NUS`
...
=== Adding a meeting: `addmeeting`
Upcoming in V2.0: addmeeting by index of person in Contacts

Adds a meeting to the address book +
Format: `addmeeting n/NAME d/DATE_TIME l/LOCATION`
...
* `addmeeting n/John Doe d/31-10-2017 21:00 l/School of Computing, NUS`
* `addmeeting n/Betsy Crowe d/27-12-2017 08:30 l/iCube Auditorium, NUS`
...
* *Addmeeting* `addmeeting INDEX [n/NAME] [d/DATE_TIME] [l/LOCATION]` +
e.g. `addmeeting 5 n/Mary Jane d/22-11-2017 l/Vivo City`
* *Clear* : `clear`
* *Delete* : `delete INDEX` +
e.g. `delete 3`
...
e.g. `find James Jake`
* *List* : `list`
* *Add Meeting* `addmeeting n/NAME d/DATE_TIME l/LOCATION` +
e.g. `addmeeting n/Mary Jane d/22-11-2017 l/Vivo City`
