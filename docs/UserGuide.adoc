...
Due to our fast changing lives, if your task was cancelled suddenly and you would like to delete the task from your task manager, simply use this delete function.
...
Note the following constraints when deleting task:
