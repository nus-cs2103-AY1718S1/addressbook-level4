...
Contag is an efficient and feature-packed address book desktop application custom-built for PC, capable of tackling even the most demanding business users and busiest frequent travellers.

=== The ConTag Help System

Fret not, we are here to help you navigate this address book.
Our help system is designed to progressively provide all necessary information from beginner to expert.

We understand that accommodating user preferences are key to ensuring a pleasant, efficient experience for all.
Apart from comprehensive help coverage in this user guide, you can also choose to get concentrated help on specific menu items with `help` in the command line of Contag or pressing the `F1` key.

=== Features and Capabilities Overview
The following list is an overview of some of the features which ConTag offers for you:

* Saving a comprehensive set of attributes of a contact in the address book to make each contact more meaningful

* Locating contact's address via the integrated Google Maps

* Creating a new schedule or activity with a contact

* Sending email to multiple emails simultaneously

=== Authors and Contributors
The intial version of the user guide was written by Team SE-EDU.
