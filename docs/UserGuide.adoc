...
To import a your contact from a pre-existing import file, you may choose to use the import functionality of Rubrika by calling the following command. +

Format: `import` `File Path` or `import`

****
* The function only imports user that do not exist in the current address book.
* Duplicate persons will be ignored.
* Only able to import .vcf or .xml files.
* Only .vcf or .xml files exported by Rubrika will work.
* You may use use an absolute path of a the import file if you want to load your import from a seperate Folder.
****
...
If you wish to export your contacts in your current Rubrika to add to another Rubrika application, you can use the export function of Rubrika by calling the following command.

Format: `export Filepath`

****
* Only .vcf or .xml files are supported.
* You may use use an absolute path of a folder if you want to save your export to a seperate Folder.
****
