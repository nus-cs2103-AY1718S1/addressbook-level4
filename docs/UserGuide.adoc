...
[TIP]
Try enabling the welcome screen, close and rerun ConTag. The welcome screen displays 1 out of the 15 default productivity quotes at random every time ConTag is run to keep you motivated throughout the day.
...
|link:#enabling-and-disabling-the-welcome-screen-since-v1.5[Welcome] | `w` | `welcome ENABLING_KEYWORD` | `welcome enable`
