...
+
image::Hints.png[width="300"]
+
and will validate your input as you type away. +
+
image::Validation.png[width="300"]
+
...
image:FindByNameInput.png[width="300"] +
image:FindByNameOutput.png[width="300"] +
...
Clicking on a tag, image:ClickTagInput.png[width="300"] +
Searches for all people with the same tag. image:ClickTagOutput.png[width="300"] +
