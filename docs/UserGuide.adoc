...
* `add n/Rob Cross p/92456877 p/64123456 e/rob@example.com a/Kent Ridge Drive 23 t/husband f/ dp/C:/Users/Seedu/Pictures/batman.png s/facebook r.cross10` +
Adds a `favorite` contact with the name `Rob Cross`, phone numbers `92456877` and `64123456`, email address `rob@example.com`,
address `Kent Ridge Drive 23`, tag `husband`, a `Facebook` account with the username `r.cross10`, and adds a `display photo` imported from the location `C:/Users/Seedu/Desktop/batman.png`.
...
* You can remove a person's display photo by including the parameter `dp/` without specifying any tags after it. [Since v1.5rc]
...
* `edit 2 f/ dp/C:/Users/Seedu/Desktop/superman.png s/instagram janedoe123 s/facebook jane.doe` +
